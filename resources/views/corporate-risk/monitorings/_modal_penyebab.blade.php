<div class="modal fade" id="modalUpdateRealisasi" tabindex="-1" role="dialog" aria-labelledby="modalUpdateRealisasi" aria-hidden="true">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p class="mb-0" id="previous_realisasi_biaya">-</p>
                                            <input type="hidden" name="previous_realisasi_biaya_value" id="previous_realisasi_biaya_value" value="0">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="small">Progress Sebelumnya:</label>
                                            <p class="mb-0" id="previous_progress">-</p>
                                            <input type="hidden" name="previous_progress_value" id="previous_progress_value" value="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
