                ...
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h2 class="h3 mb-0">Detail Loss Event Korporat</h2>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('corporate-led.edit', ['periode' => $lossEvent->periode_id, 'id' => $lossEvent->id]) }}" class="btn btn-info btn-sm">
                                <span class="bx bx-edit"></span>
                                <span class="ms-1">Edit</span>
                            </a>
                            <a href="{{ route('corporate-led.index', ['periode' => $lossEvent->periode_id]) }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div>
                                @if($lossEvent->risiko_id)
                                    <a href="{{ route('corporate-risk.view', ['riskRegister' => $lossEvent->risiko_id]) }}" 
                                      target="_blank" 
