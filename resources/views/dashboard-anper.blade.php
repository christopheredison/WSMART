      ...
      <div class="row g-3 g-xxl-2 input-filter-container">
        ...
        <div class="col-md-3 col-xxl-2">
          <select name="unit_id" id="" class="form-select select2 js-select-hide-search">
            <option value="" selected disabled>Anak Perusahaan</option>
            <option value="1">PT PP Urban</option>
            <option value="2">PT PP Infrastruktur</option>
            <option value="3">PT PP Energi</option>
            <option value="4">PT PP Properti</option>
            <option value="5">PT PP Presisi Tbk</option>
          </select>
        </div>
      </div>
    </form>
