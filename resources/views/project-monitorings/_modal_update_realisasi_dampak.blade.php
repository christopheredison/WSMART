<div class="modal fade" id="modalUpdateRealisasiDampak" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="impact_name" id="impact_name" disabled>
