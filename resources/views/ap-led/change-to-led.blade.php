            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <h2 class="h3">Ubah Risiko Menjadi Loss Event Anak Perusahaan</h2>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('risk-register-ap.loss-events.store', ['riskRegister' => $risiko->id]) }}" method="post" id="form-change-to-led">
                        @csrf
                        ...
                        <div class="col-12 mt-4">
                            <a href="{{ route('risk-register-ap.monitorings.index', ['period' => $risiko->periode_id]) }}" class="btn btn-secondary">Batal</a>
