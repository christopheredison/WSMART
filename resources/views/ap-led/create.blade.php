            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <h2 class="h3">Tambah Loss Event Anak Perusahaan</h2>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('ap-led.store') }}" method="post" id="form-create-led">
                        @csrf
                        ...
                        <input type="hidden" id="unit_id" name="unit_id" value="{{ old('unit_id', $unitId) }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control" id="identifikasi_kejadian" name="identifikasi_kejadian" rows="3" required>{{ old('deskripsi_peristiwa_risiko') }}</textarea>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control flatpickr-date bg-white" id="tanggal_kejadian" name="tanggal_kejadian"
                        ...
                        <div class="col-12 mt-4">
                            <div class="row g-2">
                                <div class="col-auto">
                                    <a href="{{ route('ap-led.index-by-periode', ['periode' => $periode->id]) }}" class="btn btn-secondary">Batal</a>
                                </div>
                                <div class="col-auto">
