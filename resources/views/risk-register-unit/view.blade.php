    ...
    <div class="col-12 mb-4">
        <div class="card shadow-sm border-0">
            <div class="card-header stepper border-0 pb-0">
                <div class="nav-link active d-flex align-items-center p-0">
                    <span class="nav-item-circle-parent">
                        <span class="nav-item-circle">14</span>
                    </span>
                                    ...
                                    <tbody>
                                        @forelse($monitoring->kriUnitMonitorings as $realisasiKri)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $realisasiKri->keyRiskIndicator->batas_aman ?? '-' }} {{ $satuanKri }}</td>
                                                <td class="text-center">{{ $realisasiKri->keyRiskIndicator->batas_waspada ?? '-' }} {{ $satuanKri }}</td>
                                                <td class="text-center">{{ $realisasiKri->keyRiskIndicator->batas_bahaya ?? '-' }} {{ $satuanKri }}</td>

                                                <td class="fw-bold text-center text-primary">{{ $realisasiKri->nilai_kri_terkini ?? '-' }} {{ $satuanKri }}</td>
                                                <td class="text-center">
