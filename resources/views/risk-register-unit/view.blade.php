                                        ...
                                        @forelse($monitoring->kriUnitMonitorings as $realisasiKri)
                                            <tr>
                                                <td>
                                                    ...
                                                    <span class="text-muted">Satuan: {{ $realisasiKri->keyRiskIndicator->satuan_kri ?? '-' }}</span>
                                                </td>
                                                <td class="text-center">{{ $realisasiKri->keyRiskIndicator->batas_aman ?? '-' }}</td>
                                                <td class="text-center">{{ $realisasiKri->keyRiskIndicator->batas_waspada ?? '-' }}</td>
                                                <td class="text-center">{{ $realisasiKri->keyRiskIndicator->batas_bahaya ?? '-' }}</td>
