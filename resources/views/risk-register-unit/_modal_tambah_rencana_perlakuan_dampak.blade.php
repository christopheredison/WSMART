<div class="modal fade" id="modalTambahRencanaDampak" role="dialog" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-content">
            <form method="POST" id="formTambahRencanaDampak">
                ...
                <div class="modal-body">
                    <div class="row g-2">
                        @include('risk-register-unit.form-perencanaan-dampak', ['suffix' => 'Dampak'])
                    </div>
                </div>
