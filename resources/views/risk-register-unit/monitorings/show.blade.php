                ...
                <div class="col-md-4">
                    <div class="card btn-reveal-trigger">
                        ...
                        <div class="card-body d-flex flex-column gap-2">
                            ...
                            <div class="form-floating">
                                <input disabled="disabled" class="form-control" type="text" name="target_skala_probabilitas"
    ...
    <div class="col-12 mt-5">
        <div class="row g-2">
            <div class="col-auto order-1">
                <a href="{{ route('risk-register-unit.monitorings.index', ['unit_id' => $risk->unit_id, 'period' => request()->route('period'), 'quarter' => $quarter, 'month' => $month]) }}" class="btn btn-outline-secondary">Kembali</a>
            </div>
        </div>
    </div>
