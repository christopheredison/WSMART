...
@if(!$unitExpired)
  ...
  @if(\App\Models\IdentifikasiRisiko::canVerifyRequestEdit(auth()->user(), 'unit') && $item->status == 6 && $item->request_edit == 1)
  ...
  @if(\App\Models\IdentifikasiRisiko::canVerifyRequestEdit(auth()->user(), 'unit') && (int) $item->close_request === 1 && !$item->is_closed)
