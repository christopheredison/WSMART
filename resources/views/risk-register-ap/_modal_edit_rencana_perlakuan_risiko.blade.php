<div class="modal fade" id="modalEditRencana" tabindex="-1" role="dialog" aria-labelledby="modalEditRencana" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-content">
            <form method="POST" id="formEditRencana">
                ...
                <div class="modal-body">
                    @include('risk-register-ap.form-perencanaan-edit') <!-- Include shared form -->
                </div>
...
$(document).ready(function() {
    ...
    $('#btnSimpanEditRencana').on('click', function(event) {
        ...
        $.ajax({
            url: `{{ route('risk-register-ap.update-rencana-perlakuan', ['riskRegister' => $identifikasiRisiko->id, 'id' => ':id']) }}`.replace(':id', perlakuanId),
            type: 'PUT',
            data: formData,
