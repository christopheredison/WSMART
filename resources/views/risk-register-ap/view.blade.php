                                    ...
                                    <tbody>
                                        @forelse($monitoring->kriUnitMonitorings as $realisasiKri)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center small">{{ $realisasiKri->keyRiskIndicator->batas_aman ?? '-' }} {{ $satuanKri }}</td>
                                                <td class="text-center small">{{ $realisasiKri->keyRiskIndicator->batas_waspada ?? '-' }} {{ $satuanKri }}</td>
                                                <td class="text-center small">{{ $realisasiKri->keyRiskIndicator->batas_bahaya ?? '-' }} {{ $satuanKri }}</td>
