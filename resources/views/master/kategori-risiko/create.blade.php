            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-3">
                        <li class="breadcrumb-item"><a href="{{ route('kategori-risiko.index') }}" class="fs-2">Kategori Risiko</a></li>
                ...
                <div class="card-header position-relative min-vh-25">
                    <form method="POST" action="{{ route('kategori-risiko.store') }}">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('kategori-risiko.index') }}" class="btn btn-secondary">Kembali</a>
