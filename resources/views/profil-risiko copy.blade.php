...
<div class="modal fade" id="detailRisikoModal" tabindex="-1" aria-labelledby="detailRisikoModalLabel"
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="detailRisikoModalLabel">Detail Peristiwa Risiko</h5>
  ...
  .dashboard-header .card .card-header h6 {
    font-size: 0.7em;
    font-weight: 600;
  }
  ...
  .dashboard-header .card .up-label {
    font-size: 1.3em;
    color: #088b13;
  }

  /* add arrow up-right after content */
  .dashboard-header .card .up-label::after {
    content: '\1F855';
    display: inline-block;
    position: relative;
  }

  .dashboard-header .card .down-label {
    font-size: 1.3em;
    color: #e80c0c;
  }

  /* add arrow down-right after content */
  .dashboard-header .card .down-label::after {
    content: '\1F856';
    display: inline-block;
    position: relative;
  }
  ...
  .dashboard-content .card .card-subtitle {
    font-size: 0.6em;
    font-weight: 400;
    position: absolute;
    bottom: 0;
  ...
  .map-table .data-cell.moderate {
    color: black;
  }

  .map-table .data-cell .kode-peristiwa {
    font-size: 1em;
    font-weight: bold;
  }
  ...
  .map-table td:not(.table-legend):not(.useless-cell) {
    height: 42px;
    width: 19%;
    padding: 2px;
  }

  .map-table .table-legend {
    font-size: 0.6em;
    letter-spacing: 5px;
  }
  ...
  .table-strategi tbody td {
    padding: 5px;
    vertical-align: top;
  }

  .table-strategi:not(.default-left) td:not(.left-align),
  .table-strategi:not(.default-left) th:not(.left-align) {
    text-align: center;
  }
  ...
  .clickable-show-risiko {
    cursor: pointer;
    padding-left: 10px;
  }

  .clickable-show-risiko::before {
    content: '\1F441';
    margin-right: 5px;
  }
  </style> -->
  ...
  const refreshSummary = () => {
    ...
    dashboardData.prir.forEach((prir) => {
      ...
      $(`#prir-card .data-cell[data-posisi-risiko="${prir.rre}"]`).data('kode-peristiwa').push(prir.kode);
    });
