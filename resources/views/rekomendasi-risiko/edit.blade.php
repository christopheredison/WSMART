                            ...
                            <div class="row g-2 @if(!$loop->first) mt-2 @endif">
                                <div class="col-12 col-lg-11">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-6 col-md-3"><div class="form-group form-floating"><input type="text" class="form-control border-warning" name="batas_waspada[]" value="{{ $kri->batas_waspada }}" placeholder="Batas Waspada"><label>Batas Waspada</label></div></div>
