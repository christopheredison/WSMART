    ...
    <div class="card btn-reveal-trigger">
      <div class="card-header d-flex align-items-center gap-3">
        ...
        <div class="d-block">
          ...
          <h2>List Sasaran Risiko</h2>
        </div>
        <div class="ms-auto d-flex align-items-center gap-3">
          <div class="col-auto">
            <a href="{{ route('projects.verifikasi-pengajuan.index', ['tab' => 'sasaran']) }}" type="button"
          ...
          <table class="table ajax-datatable" id="example" data-paging="true" data-info="true" data-filter="true">
            <thead>
              <tr>
                ...
                <th class="sort" data-sort="sasaran">Sasaran Risiko</th>
              ...
              @foreach ($items as $index => $item)
                ...
                <tr>
                  ...
                  <td class="sumber">
                    ...
                    @else
                      <div class="badge bg-info">KPI / Master</div>
                    @endif
                  </td>
                  ...
                  <td class="white-space-nowrap">
                    <button type="button" class="btn-input-icon btn-view-detail"
                      ...
                      data-sumber="{{ $isCustom ? 'Pengajuan Proyek' : 'KPI / Master' }}"
...
$(document).ready(function() {
  $(document).on('click', '.btn-view-detail', function() {
    Swal.fire({
      title: 'Detail Sasaran Risiko',
      html: `
        <div class="text-start">
          <p class="mb-2"><strong>Sasaran Risiko:</strong><br>${$(this).data('sasaran') || '-'}</p>
