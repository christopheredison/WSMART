<div class="modal fade" id="modalEditRencanaDampak" role="dialog" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-content">
            <form method="POST" id="formEditRencanaDampak">
                ...
                <div class="modal-body">
                    <div class="row g-2">
                        @include('project-risk.form-perencanaan-dampak-edit', ['suffix' => 'EditDampak', 'prefix' => 'x'])
                    </div>
                </div>
