            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <h2 class="h3">Edit Loss Event Unit</h2>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('unit-led.update', $lossEvent->id) }}" method="post" id="form-unit-led">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <!-- Periode -->
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('periode_id') is-invalid @enderror" name="periode_id" required>
                                    ...
                                    @foreach($periodes as $periode)
                                        <option value="{{ $periode->id }}" {{ old('periode_id', $lossEvent->periode_id) == $periode->id ? 'selected' : '' }}>
                                            {{ $periode->tahun }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3" id="no_urut_container" style="display: {{ old('status_risk_register', $lossEvent->status_risk_register) == '1' ? 'block' : 'none' }};">
                                ...
                                <select class="form-select @error('no_urut_risiko') is-invalid @enderror" name="no_urut_risiko" id="risk_register_id" required data-value="{{ $lossEvent->no_urut_risiko }}">
                                </select>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('nama_kejadian') is-invalid @enderror" 
                                    name="nama_kejadian" rows="3" required>{{ old('nama_kejadian', $lossEvent->nama_kejadian) }}</textarea>
                                @error('nama_kejadian')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('tanggal_kejadian') is-invalid @enderror" 
                                    ...
                                    value="{{ old('tanggal_kejadian', $lossEvent->tanggal_kejadian) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('identifikasi_kejadian') is-invalid @enderror" 
                                    name="identifikasi_kejadian" rows="3" required>{{ old('identifikasi_kejadian', $lossEvent->identifikasi_kejadian) }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('kategori_kejadian_id') is-invalid @enderror" name="kategori_kejadian_id" required>
                                    ...
                                    @foreach($kategoriKejadians as $kategori)
                                        <option value="{{ $kategori->id }}" {{ old('kategori_kejadian_id', $lossEvent->kategori_kejadian_id) == $kategori->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('sumber_penyebab_kejadian') is-invalid @enderror" name="sumber_penyebab_kejadian" required>
                                    ...
                                    <option value="1" {{ old('sumber_penyebab_kejadian', $lossEvent->sumber_penyebab_kejadian) == '1' ? 'selected' : '' }}>Internal</option>
                                    <option value="2" {{ old('sumber_penyebab_kejadian', $lossEvent->sumber_penyebab_kejadian) == '2' ? 'selected' : '' }}>Eksternal</option>
                                </select>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('penyebab_masalah') is-invalid @enderror" 
                                    name="penyebab_masalah" rows="3" required>{{ old('penyebab_masalah', $lossEvent->penyebab_masalah) }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('penanganan_kejadian') is-invalid @enderror" 
                                    name="penanganan_kejadian" rows="3" required>{{ old('penanganan_kejadian', $lossEvent->penanganan_kejadian) }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('deskripsi_kejadian') is-invalid @enderror" 
                                    name="deskripsi_kejadian" rows="4" required>{{ old('deskripsi_kejadian', $lossEvent->deskripsi_kejadian) }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('kategori_risiko_bumn') is-invalid @enderror" name="kategori_risiko_bumn" required>
                                    ...
                                    <option value="1" {{ old('kategori_risiko_bumn', $lossEvent->kategori_risiko_bumn) == '1' ? 'selected' : '' }}>Financial</option>
                                    <option value="2" {{ old('kategori_risiko_bumn', $lossEvent->kategori_risiko_bumn) == '2' ? 'selected' : '' }}>Operational</option>
                                    <option value="3" {{ old('kategori_risiko_bumn', $lossEvent->kategori_risiko_bumn) == '3' ? 'selected' : '' }}>Public & Legal</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="hidden" name="kategori_risiko_id" value="{{ old('kategori_risiko_id', $lossEvent->kategori_risiko_id) }}" id="kategori_risiko_id">
                                <select class="form-select @error('jenis_risiko_id') is-invalid @enderror" name="jenis_risiko_id" id="jenis_risiko_id" required onchange="handleJenisRisikoChange(this)">
                                    ...
                                    @foreach($jenisRisikos as $jenis)
                                        <option value="{{ $jenis->id }}" 
                                            ...
                                            {{ old('jenis_risiko_id', $lossEvent->jenis_risiko_id) == $jenis->id ? 'selected' : '' }}>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('penjelasan_kerugian') is-invalid @enderror" 
                                    name="penjelasan_kerugian" rows="3" required>{{ old('penjelasan_kerugian', $lossEvent->penjelasan_kerugian) }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control inputmask-rupiah @error('nilai_kerugian_finansial') is-invalid @enderror" 
                                    name="nilai_kerugian_finansial" value="{{ old('nilai_kerugian_finansial', $lossEvent->nilai_kerugian_finansial) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('kejadian_berulang') is-invalid @enderror" name="kejadian_berulang" id="kejadian_berulang" required>
                                    ...
                                    <option value="1" {{ old('kejadian_berulang', $lossEvent->kejadian_berulang) == '1' ? 'selected' : '' }}>Ya</option>
                                    <option value="0" {{ old('kejadian_berulang', $lossEvent->kejadian_berulang) == '0' ? 'selected' : '' }}>Tidak</option>
                                </select>
                            ...
                            <!-- Frekuensi Kejadian -->
                            <div class="col-md-6 mb-3" id="frekuensi_container" style="display: {{ old('kejadian_berulang', $lossEvent->kejadian_berulang) == '1' ? 'block' : 'none' }};">
                                ...
                                <select class="form-select @error('frekuensi_kejadian') is-invalid @enderror" name="frekuensi_kejadian">
                                    ...
                                    <option value="1" {{ old('frekuensi_kejadian', $lossEvent->frekuensi_kejadian) == '1' ? 'selected' : '' }}>1 kali</option>
                                    <option value="2" {{ old('frekuensi_kejadian', $lossEvent->frekuensi_kejadian) == '2' ? 'selected' : '' }}>2 kali</option>
                                    <option value="3" {{ old('frekuensi_kejadian', $lossEvent->frekuensi_kejadian) == '3' ? 'selected' : '' }}>3 kali</option>
                                    <option value="4" {{ old('frekuensi_kejadian', $lossEvent->frekuensi_kejadian) == '4' ? 'selected' : '' }}>4 kali</option>
                                    <option value="5" {{ old('frekuensi_kejadian', $lossEvent->frekuensi_kejadian) == '5' ? 'selected' : '' }}>5 kali</option>
                                    <option value="6" {{ old('frekuensi_kejadian', $lossEvent->frekuensi_kejadian) == '6' ? 'selected' : '' }}>6 kali atau lebih</option>
                                </select>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('rencana_mitigasi') is-invalid @enderror" 
                                    name="rencana_mitigasi" rows="3" required>{{ old('rencana_mitigasi', $lossEvent->rencana_mitigasi) }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('realisasi_mitigasi') is-invalid @enderror" 
                                    name="realisasi_mitigasi" rows="3" required>{{ old('realisasi_mitigasi', $lossEvent->realisasi_mitigasi) }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('perbaikan_mendatang') is-invalid @enderror" 
                                    name="perbaikan_mendatang" rows="3" required>{{ old('perbaikan_mendatang', $lossEvent->perbaikan_mendatang) }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('status_asuransi') is-invalid @enderror" name="status_asuransi" id="status_asuransi" required>
                                    <option value="">Pilih Status</option>
                                    <option value="1" {{ old('status_asuransi', $lossEvent->status_asuransi) == '1' ? 'selected' : '' }}>Ya</option>
                                    <option value="0" {{ old('status_asuransi', $lossEvent->status_asuransi) == '0' ? 'selected' : '' }}>Tidak</option>
                                </select>
                            ...
                            <!-- Nilai Premi -->
                            <div class="col-md-6 mb-3" id="premi_container" style="display: {{ old('status_asuransi', $lossEvent->status_asuransi) == '1' ? 'block' : 'none' }};">
                                ...
                                <input type="text" class="form-control inputmask-rupiah @error('nilai_premi') is-invalid @enderror" 
                                    name="nilai_premi" value="{{ old('nilai_premi', $lossEvent->nilai_premi) }}">
                                @error('nilai_premi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <!-- Nilai Klaim -->
                            <div class="col-md-6 mb-3" id="klaim_container" style="display: {{ old('status_asuransi', $lossEvent->status_asuransi) == '1' ? 'block' : 'none' }};">
                                ...
                                <input type="text" class="form-control inputmask-rupiah @error('nilai_klaim') is-invalid @enderror" 
                                    name="nilai_klaim" value="{{ old('nilai_klaim', $lossEvent->nilai_klaim) }}">
                                @error('nilai_klaim')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control inputmask-rupiah @error('biaya_risiko_inheren') is-invalid @enderror" 
                                    name="biaya_risiko_inheren" value="{{ old('biaya_risiko_inheren', $lossEvent->biaya_risiko_inheren) }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control inputmask-rupiah @error('biaya_upaya_perbaikan') is-invalid @enderror" 
                                    name="biaya_upaya_perbaikan" value="{{ old('biaya_upaya_perbaikan', $lossEvent->biaya_upaya_perbaikan) }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control inputmask-rupiah @error('hasil_perbaikan') is-invalid @enderror" 
                                    name="hasil_perbaikan" value="{{ old('hasil_perbaikan', $lossEvent->hasil_perbaikan) }}">
...
$(document).ready(function() {
    ...
    $('form').on('submit', function(e) {
        ...
        Swal.fire({
            title: 'Konfirmasi',
            text: 'Apakah Anda yakin ingin mengupdate data Loss Event Unit ini?',
            icon: 'question',
    ...
    $('#status_risk_register').change(function() {
        if ($(this).val() == '1') {
            ...
            $('select[name="no_urut_risiko"]').prop('required', true);
            if ($('select[name="no_urut_risiko"]').data('value')) {
                $('select[name="no_urut_risiko"]').val($('select[name="no_urut_risiko"]').data('value')).change().data('value', null);
            }
        } else {
            $('#no_urut_container').hide();
            $('select[name="no_urut_risiko"]').prop('required', false);
        }
    });
