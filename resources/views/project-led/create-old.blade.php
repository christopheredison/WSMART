    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('project-led.store') }}" method="post" id="form-project-led">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('status_risk_register') is-invalid @enderror" name="status_risk_register" id="status_risk_register" required>
                                    ...
                                    <option value="1" {{ old('status_risk_register') == '1' || (old('status_risk_register') == null && request()->project_id) ? 'selected' : '' }}>Ya</option>
                            ...
                            <!-- No Urut Risiko -->
                            <div class="col-md-6 mb-3 status_risk_register_ya" style="display: none;">
