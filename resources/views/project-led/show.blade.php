            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h2 class="h3 mb-0">Detail Loss Event Project{{ $project ? ' - ' . $project->project_name : '' }}</h2>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('project-led.edit', ['project' => $lossEvent->project_id, 'id' => $lossEvent->id]) }}" class="btn btn-info btn-sm">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-3">Penyebab dan Penanganan Saat Kejadian</h5>
                        @forelse($lossEvent->penyebabRisikoProjectLeds as $penyebab)
                            <div class="mb-4">
