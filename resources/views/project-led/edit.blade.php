                            ...
                            <div class="col-12">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('project_sektor_id') is-invalid @enderror" name="project_sektor_id" required>
                                        ...
                                        @foreach($projectSektors as $sektor)
                                            <option value="{{ $sektor->id }}" {{ old('project_sektor_id', $lossEvent->project_sektor_id) == $sektor->id ? 'selected' : '' }}>
                                                {{ $sektor->sektor_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('project_id') is-invalid @enderror" name="project_id" required>
                                        ...
                                        @foreach($projects as $project)
                                            <option value="{{ $project->id }}" {{ old('project_id', $lossEvent->project_id) == $project->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nilai_kerugian_non_finansial') is-invalid @enderror" 
                                        name="nilai_kerugian_non_finansial" value="{{ old('nilai_kerugian_non_finansial', $lossEvent->nilai_kerugian_non_finansial) }}">
