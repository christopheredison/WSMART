  ...
  <div class="col-12">
    <div class="card border-0 dashboard-header">
      ...
      <div class="card-header text-white border-0 mt-auto mb-5">
        <!-- <h1 class="mb-2">Risk Dashboard {{ __('basic.dashboard_types.' . $dashboardType) }}</h1> -->
        <h1 class="mb-2">Risk Dashboard Corporate</h1>
  ...
  <div class="col-12">
    <form action="{{ url()->current() }}">
      <div class="row g-3 g-xxl-2 input-filter-container">
        ...
        <!-- @if($dashboardType == 'fakultas')
        <div class="col-md-3 col-xxl-2">
          <select name="fakultas_id" id="fakultas_selector" class="form-select select2 js-select-hide-search">
            <option value="" selected disabled>Unit</option>
            @foreach ($fakultases as $fakultas)
            <option value="{{ $fakultas->id }}" {{ $fakultas->id == request()->fakultas_id ? 'selected' : '' }}>
              {{ $fakultas->name }}</option>
            @endforeach
          </select>
        </div>
        @elseif($dashboardType == 'biro')
        <div class="col-md-3 col-xxl-2">
          <select name="biro_id" id="biro_selector" class="form-select select2 js-select-hide-search">
            <option value="" selected disabled>Biro</option>
            @foreach ($biros as $biro)
            <option value="{{ $biro->id }}" {{ $biro->id == request()->biro_id ? 'selected' : '' }}>
              {{ $biro->name }}
            </option>
            @endforeach
          </select>
  ...
  <div class="col-12">
    <div class="row g-3">
      <div class="col-6 col-md-3">
        <div class="card card-sm" id="tck-card">
          ...
          <div class="card-body">
            <div class="ratio ratio-1x1 ratio-lg-4x3 ratio-xxl-16x9 ratio-xxxl-21x9">
              <div id="tck-chart"></div>
            </div>
          </div>
          <div class="card-footer">
            <div class="row w-100 gx-0">
              <div class="col-6 col-md-auto changes-summary"></div>
              <div class="col-6 col-md-auto last-changes"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card card-sm" id="jkk-card">
          ...
          <div class="card-body d-flex-center align-items-center">
            <div id="jkk-chart" class="d-block text-center">
              <div class="counter" id="jkk-counter"></div>
            </div>
          </div>
          <div class="card-footer">
            <div class="row w-100 gx-0">
              ...
              <tr>
                ...
                <td>
                  <div class="data-cell" data-id="1">
                    <div class="kode-peristiwa">
                      <span class="residual">R1</span>
                    </div>
                    <div class="posisi-risiko">7</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="2">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">12</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="3">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">17</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="4">
                    <div class="kode-peristiwa">R1</div>
                    <div class="posisi-risiko">22</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="5">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">25</div>
                  </div>
                </td>
              </tr>
              <tr>
                <td>
                  <div class="data-cell" data-id="6">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">4</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="7">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">9</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="8">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">14</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="9">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">19</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="10">
                    <div class="kode-peristiwa">R2</div>
                    <div class="posisi-risiko">24</div>
                  </div>
                </td>
              </tr>
              <tr>
                <td>
                  <div class="data-cell" data-id="11">
                    <div class="kode-peristiwa">
                      <span class="residual">R2, R3</span>
                    </div>
                    <div class="posisi-risiko">3</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="12">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">8</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="13">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">13</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="14">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">18</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="15">
                    <div class="kode-peristiwa">R3</div>
                    <div class="posisi-risiko">23</div>
                  </div>
                </td>
              </tr>
              <tr>
                <td>
                  <div class="data-cell" data-id="16">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">2</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="17">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">6</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="18">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">11</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="19">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">16</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="20">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">21</div>
                  </div>
                </td>
              </tr>
              <tr>
                <td>
                  <div class="data-cell" data-id="21">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">1</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="22">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">5</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="23">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">10</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="24">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">15</div>
                  </div>
                </td>
                <td>
                  <div class="data-cell" data-id="25">
                    <div class="kode-peristiwa"></div>
                    <div class="posisi-risiko">20</div>
                  </div>
                </td>
              </tr>
              <tr>
        ...
        <div class="d-block">
          ...
          <div class="table-responsive scrollbar">
            <table class="table table-strategi">
              ...
              <tr>
                  <td class="left-align">
                    <span class="btn-link">R1: Peristiwa Risiko 1</span>
                  </td>
                  <td>22</td>
                  <td>7</td>
                  <td class="left-align">Dilakukan perencanaan penanganan....</td>
                  <td>31 Jan 2025</td>
                </tr>
                <tr>
                  <td class="left-align">
                    <span class="btn-link">R2: Peristiwa Risiko 2</span>
                  </td>
                  <td>24</td>
                  <td>3</td>
                  <td class="left-align">Dilakukan perencanaan penanganan....</td>
                ...
                <tr>
                  <td class="left-align">
                    <span class="btn-link">R3: Peristiwa Risiko 3</span>
                  </td>
                  <td>23</td>
                  <td>3</td>
                  <td class="left-align">Dilakukan perencanaan penanganan....</td>
            ...
            <table class="table table-strategi">
              <thead>
                <tr>
                  ...
                  <th rowspan="2" class="left-align">Strategi Perlakuan Risiko (Realisasi)</th>
                  <th rowspan="2" class="white-space-nowrap">Tenggat Waktu</th>
                </tr>
                <tr>
                  <th>CRE</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td>17</td>
                  <td>7</td>
                  <td class="left-align">Telah Dilakukan....</td>
                  <td>31 Jan 2025</td>
                </tr>
                <tr>
                  <td class="left-align">
          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <th class="white-space-nowrap">KPI terpengaruh</th>
                <th>KRI</th>
            ...
            <tbody>
              <tr>
                  <td>Peristiwa Risiko 1</td>
                  <td>Terjadi Peristiwa Risiko 1</td>
                  <td>Risiko Operasional</td>
                  <td class="level_risiko text-center">
                      <div class="badge high">22</div>
                  </td>
                  <td>KPI Operasional</td>
                  <td>KRI 1</td>
              ...
              <tr>
                  <td>Peristiwa Risiko 2</td>
                  <td>Terjadi Peristiwa Risiko 2</td>
                  <td>Risiko Operasional</td>
                  <td class="level_risiko text-center">
                      <div class="badge high">24</div>
                  </td>
                  <td>KPI Operasional</td>
                  <td>KRI 2</td>
                  <td class="text-center">
              ...
              <tr>
                  <td>Peristiwa Risiko 3</td>
                  <td>Terjadi Peristiwa Risiko 3</td>
                  <td>Risiko Hukum</td>
                  <td class="level_risiko text-center">
                      <div class="badge high">23</div>
                  </td>
                  <td>KPI Hukum</td>
                  <td>KRI 3</td>
                  <td class="text-center">
        ...
        <div class="table-responsive scrollbar">
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                  <td>12 Mar 2024</td>
                  <td>Peristiwa Kerugian 2</td>
                  <td>Risiko Pasar</td>
                  <td>IDR 3.000.000.000</td>
                  <td>-</td>
                  <td>
                    <ol>
                      <li>
...
const refreshSummary = () => {
  ...
  if (dashboardData.tck_c >= 0) {
    ...
    $('#tck-card .changes-summary').html(`<span class="down-label">${dashboardData.tck_c}%</span> Since last month`);
  }
