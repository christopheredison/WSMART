...
<form class="row g-3" method="POST" action="{{ route('risk-register.store') }}" id="main-form">
        ...
        <div class="row g-3 gx-md-5">
          ...
          <div class="col-md-6">
            <div class="form-group d-lg-flex">
              ...
              <textarea class="form-control" id="deskripsi_rencana_kegiatan" name="deskripsi_rencana_kegiatan" rows="3"
                value="{{ old('deskripsi_rencana_kegiatan') }}" required></textarea>
              {{--
              <select class="form-select select2" name="rencana_kegiatan[]" multiple="multiple" required>
                @foreach($rencanaKegiatan as $id => $title)
                <option value="{{ $id }}" {{ in_array($id, old('rencana_kegiatan', [])) ? 'selected' : '' }}>
              {{ $title }}</option>
              @endforeach
              </select>
              --}}
          ...
          <div class="col-md-6">
            <div class="form-group d-lg-flex">
              ...
              <select class="form-select select2 js-select-hide-search" name="peristiwa_risiko_id" id="peristiwa_risiko"
                required>
                <option selected disabled>Pilih</option>
          ...
          <div class="col-12">
            <div class="form-group form-floating">
              <textarea class="form-control" id="deskripsi_peristiwa_risiko" name="deskripsi_peristiwa_risiko" rows="3"
                value="{{ old('deskripsi_peristiwa_risiko') }}" placeholder="Deskripsi Peristiwa Risiko"
                required></textarea>
        ...
        <div id="penyebab-risiko-body">
          <div class="row g-2" id="row-0">
            ...
            <div class="col-auto d-flex align-items-center">
              <button type="button" class="btn btn-icon-danger h-100" onclick="removeRow('row-0')">
          ...
          <div class="row g-2" id="row-1">
            <div class="col-12 col-lg-11">
              <div class="row g-2">
                <div class="col-12">
                  <div class="form-group form-floating">
                    <input type="text" class="form-control" name="key_risk_indicator[]" id="key_risk_indicator_1"
                      placeholder="Key Risk Indicator">
                    <label for="key_risk_indicator_1">Key Risk Indicator</label>
                  </div>
                </div>
                <div class="col-6 col-md-3 col-lg-auto flex-lg-grow-1">
                  <div class="form-group form-floating">
                    <input type="text" class="form-control" name="satuan_kri[]" id="satuan_kri_1"
                      placeholder="Satuan KRI">
                    <label for="satuan_kri_1">Satuan KRI</label>
                  </div>
                </div>
                <div class="col-6 col-md-3 col-lg-auto flex-lg-grow-1">
                  <div class="form-group form-floating text-center">
                    <input type="text" class="form-control border-success" name="batas_aman[]" id="batas_aman_1"
                ...
                <div class="col-6 col-md-3 col-lg-auto flex-lg-grow-1">
                  <div class="form-group form-floating text-center">
                    <input type="text" class="form-control border-warning" name="batas_waspada[]" id="batas_waspada_1"
                      placeholder="Batas Waspada">
                    <label for="batas_waspada_1">Batas Waspada</label>
                  </div>
                </div>
                <div class="col-6 col-md-3 col-lg-auto flex-lg-grow-1">
                  <div class="form-group form-floating text-center">
                    <input type="text" class="form-control border-danger" name="batas_bahaya[]" id="batas_bahaya_1"
                      placeholder="Batas Bahaya">
            ...
            <div class="col-auto d-flex align-items-center ms-auto">
              <button type="button" class="btn btn-icon-danger h-100" onclick="removeRow('row-1')">
                <i class="bx bx-trash"></i>
              </button>
            </div>
            <div class="col-12 mt-0">
  ...
  <div class="col-12 mt-5">
    <div class="row g-2">
      ...
      <div class="col-auto order-3 px-0 px-md-1 d-flex">
        <button type="button" id="draft_button" class="btn btn-danger ms-auto">Save as Draft</button>
      </div>
    </div>
  </div>
</form>
