...
return new class extends Migration
{
    ...
    {
        Schema::create('perlakuan_penyebab_risiko_ap_leds', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('penyebab_risiko_led_id', 'fk_perlakuan_ap_leds_to_penyebab_ap_leds')
                  ->references('id')
                  ->on('penyebab_risiko_ap_leds')
                  ->onDelete('set null');
    ...
    {
        Schema::dropIfExists('perlakuan_penyebab_risiko_ap_leds');
    }
};
