...
return new class extends Migration
{
    ...
    {
        Schema::create('perlakuan_dampak_risiko_units', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('risiko_id');
            $table->unsignedBigInteger('dampak_risiko_id');
            ...
            $table->foreign('dampak_risiko_id')->references('id')->on('dampak_risiko_units')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('perlakuan_dampak_risiko_units');
    }
};
