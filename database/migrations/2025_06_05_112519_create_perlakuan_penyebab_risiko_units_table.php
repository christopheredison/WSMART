...
return new class extends Migration
{
    ...
    {
        Schema::create('perlakuan_penyebab_risiko_units', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('penyebab_risiko_id')->references('id')->on('penyebab_risikos')->onDelete('set null');
        });
    }
    ...
    {
        Schema::dropIfExists('perlakuan_penyebab_risiko_units');
    }
};
