...
return new class extends Migration
{
    ...
    {
        Schema::create('perlakuan_dampak_monitoring_units', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('perlakuan_dampak_id')->references('id')->on('perlakuan_dampak_risiko_units')->onDelete('cascade');
            $table->foreign('monitoring_id')->references('id')->on('unit_risk_monitorings')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('perlakuan_dampak_monitoring_units');
    }
};
