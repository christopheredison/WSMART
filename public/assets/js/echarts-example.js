...
var echartsAreaPiecesChartInit = function echartsAreaPiecesChartInit() {
  var $areaPiecesChartEl = document.querySelector(
    ".echart-area-pieces-chart-example"
  );
...
var echartsBarNegativeChartInit = function echartsBarNegativeChartInit() {
  var $barNegativeChartEl = document.querySelector(
    ".echart-bar-chart-negative-example"
  );
...
var echartsBarRaceChartInit = function echartsBarRaceChartInit() {
  var $barRaceChartEl = document.querySelector(
    ".echart-bar-race-chart-example"
  );
  if ($barRaceChartEl) {
    // Get options from data attribute
...
var echartsBarSeriesChartInit = function echartsBarSeriesChartInit() {
  var $barSeriesChartEl = document.querySelector(
    ".echart-bar-chart-series-example"
  );
  if ($barSeriesChartEl) {
    // Get options from data attribute
...
var echartsBarStackedChartInit = function echartsBarStackedChartInit() {
  var $barStackedChartEl = document.querySelector(
    ".echart-bar-stacked-chart-example"
  );
...
var echartsBarTimelineChartInit = function echartsBarTimelineChartInit() {
  var $barTimelineChartEl = document.querySelector(
    ".echart-bar-timeline-chart-example"
  );
      ...
      return Object.keys(obj).reduce(function (acc, val) {
        return _objectSpread(
          ...
          _defineProperty(
            {},
            val,
            obj[val].map(function (value, index) {
              return {
                name: months[index],
                value: value,
              };
...
var echartsWaterFallChartInit = function echartsWaterFallChartInit() {
  var $waterfallChartEl = document.querySelector(
    ".echart-nightfall-chart-example"
  );
  if ($waterfallChartEl) {
    // Get options from data attribute
      ...
      return {
        ...
        tooltip: {
          ...
          formatter: function formatter(params) {
            ...
            return ""
              .concat(window.dayjs(tar.name).format("MMM DD"), "<br/>")
              .concat(tar.seriesName, ": ")
              .concat(tar.value);
          },
          transitionDuration: 0,
          axisPointer: {
...
var echartsBasicCandlestickChartInit =
  function echartsBasicCandlestickChartInit() {
    var $basicCandleStickChartEl = document.querySelector(
      ".echart-candlestick-chart-example"
    );
...
var echartsBasicGaugeChartInit = function echartsBasicGaugeChartInit() {
  var $basicGaugeChartEl = document.querySelector(
    ".echart-basic-gauge-chart-example"
  );
...
var echartsLineChartInit = function echartsLineChartInit() {
  var $lineChartEl = document.getElementById("echart-line-chart-example");
  if ($lineChartEl) {
    // Get options from data attribute
...
var echartsCandlestickMixedChartInit =
  function echartsCandlestickMixedChartInit() {
    var $candleStickMixedChartEl = document.querySelector(
...
var echartsDoughnutChartInit = function echartsDoughnutChartInit() {
  var $doughnutChartEl = document.querySelector(
...
var echartsDoughnutRoundedChartInit =
  function echartsDoughnutRoundedChartInit() {
    var $doughnutRoundedChartEl = document.querySelector(
...
var echartsDynamicLineChartInit = function echartsDynamicLineChartInit() {
  var $dynamicLineChartEl = document.querySelector(
...
var echartsGaugeGradeChartInit = function echartsGaugeGradeChartInit() {
  var $gaugeGradeChartEl = document.querySelector(
    ".echart-gauge-grade-chart-example"
  );
...
var echartsGaugeMultiRingChartInit = function echartsGaugeMultiRingChartInit() {
  var $gaugeMultiRingChartEl = document.querySelector(
...
var echartsGaugeMultiTitleChartInit =
  function echartsGaugeMultiTitleChartInit() {
    var $gaugeMultiTitleChartEl = document.querySelector(
...
var echartsGaugeProgressChartInit = function echartsGaugeProgressChartInit() {
  var $gaugeProgressChartEl = document.querySelector(
...
var echartsGaugeRingChartInit = function echartsGaugeRingChartInit() {
  var $gaugeRingChartEl = document.querySelector(
...
var echartsGradientBarChartInit = function echartsGradientBarChartInit() {
  var $gradientBarChartEl = document.querySelector(
  ...
  if ($gradientBarChartEl) {
    ...
    var _tooltipFormatter6 = function _tooltipFormatter6(params) {
      return '<div> \n          <h6 class="fs-10 text-700 mb-0">\n          <span class="dot me-1 fs-11  bg-primary" ></span> '
        .concat(params[0].name, " : ")
        .concat(params[0].value, " \n           </h6>\n        </div> ");
    };
    var dataAxis = [
...
var echartsHeatMapSingleSeriesChartInit =
  function echartsHeatMapSingleSeriesChartInit() {
...
var echartsHorizontalBarChartInit = function echartsHorizontalBarChartInit() {
  var $horizontalBarChartEl = document.querySelector(
...
var echartsLineAreaChartInit = function echartsLineAreaChartInit() {
  var $lineAreaChartEl = document.querySelector(
...
var echartsLineGradientChartInit = function echartsLineGradientChartInit() {
  var $lineGradientChartEl = document.querySelector(
...
var echartsLineLogChartInit = function echartsLineLogChartInit() {
  var $lineLogChartEl = document.querySelector(
    ".echart-line-log-chart-example"
  );
  if ($lineLogChartEl) {
    // Get options from data attribute
...
var echartsLineMarkerChartInit = function echartsLineMarkerChartInit() {
  var $lineMarkerChartEl = document.querySelector(
...
var echartsLineRaceChartInit = function echartsLineRaceChartInit() {
  var $lineRaceChartEl = document.querySelector(
...
var echartsLineShareDatasetChartInit =
  function echartsLineShareDatasetChartInit() {
    var $lineShareChartEl = document.querySelector(
      ".echart-line-share-dataset-chart-example"
    );
    if ($lineShareChartEl) {
      // Get options from data attribute
...
var echartsNestedPiesChartInit = function echartsNestedPiesChartInit() {
  var $echartsNestedPies = document.querySelector(
...
var echartsPieEdgeAlignChartInit = function echartsPieEdgeAlignChartInit() {
  var $echartPieAEdgeAlignChartEl = document.querySelector(
...
var echartsPieLabelAlignChartInit = function echartsPieLabelAlignChartInit() {
  var $echartPieLabelAlignChartEl = document.querySelector(
...
var echartsPieMultipleChartInit = function echartsPieMultipleChartInit() {
  var $echartPieMultipleChartEl = document.querySelector(
...
var echartsRadarCustomizedChartInit =
  function echartsRadarCustomizedChartInit() {
    var $radarChartEl = document.querySelector(
    ...
    function getFormatter(params) {
      ...
      return "<strong > "
        ...
        .concat(indicators[params.seriesIndex][0], "</strong>: ")
        .concat(params.value[0], "  <br>\n      <strong>")
        .concat(indicators[num][1], "</strong>: ")
        .concat(params.value[1], "  <br>\n      <strong>")
        .concat(indicators[num][2], "</strong>: ")
        .concat(params.value[2], "  <br>\n      <strong>")
        .concat(indicators[num][3], "</strong>: ")
        .concat(params.value[3], "  <br>\n      <strong>")
        .concat(indicators[num][4], "</strong>: ")
        .concat(params.value[4], "  <br>\n      <strong>")
        .concat(indicators[num][5], "</strong>: ")
...
var echartsScatterBasicChartInit = function echartsScatterBasicChartInit() {
  var $basicScatterChartEl = document.querySelector(
...
var echartsScatterQuartetChartInit = function echartsScatterQuartetChartInit() {
  var $scatterQuartetChartEl = document.querySelector(
...
var echartsScatterSingleAxisChartInit =
  function echartsScatterSingleAxisChartInit() {
    var $scatterSingleAxisChartEl = document.querySelector(
...
var echartsStackedAreaChartInit = function echartsStackedAreaChartInit() {
  var $stackedAreaChartEl = document.querySelector(
...
var echartsHorizontalStackedChartInit =
  function echartsHorizontalStackedChartInit() {
    var $horizontalStackChartEl = document.querySelector(
...
var echartsStackedLineChartInit = function echartsStackedLineChartInit() {
  var $stackedLineChartEl = document.querySelector(
...
var echartsStackedVerticalChartInit =
  function echartsStackedVerticalChartInit() {
    var $stackedVerticalChart = document.querySelector(
      ".echart-stacked-vertival-chart-example"
    );
...
var echartsStepLineChartInit = function echartsStepLineChartInit() {
  var $stepLineChartEl = document.querySelector(
