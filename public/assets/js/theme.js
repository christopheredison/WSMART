/******/ (() => {
    ...
    \*************************************/
      /***/ (
        ...
        /* harmony import */ var _node__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./node */ "./resources/js/node.js");
  ...
  -----------------------------------------------*/
        ...
        var BulkSelect = /*#__PURE__*/ (function () {
          function BulkSelect(element, option) {
            ...
            this.element = new _node__WEBPACK_IMPORTED_MODULE_0__["default"](
              element
            );
          ...
          _createClass(BulkSelect, [
            ...
            },
            {
              ...
              value: function attachNodes() {
                ...
                this.actions = new _node__WEBPACK_IMPORTED_MODULE_0__[
                  "default"
                ](document.getElementById(actions));
                this.replacedElement = new _node__WEBPACK_IMPORTED_MODULE_0__[
                  "default"
                ...
                this.element.on("click", function () {
                  if (_this.element.attr("indeterminate") === "indeterminate") {
                    ...
                    _this.bulkSelectRows.forEach(function (el) {
                      var rowCheck = new _node__WEBPACK_IMPORTED_MODULE_0__[
                        "default"
                      ](el);
                  ...
                  _this.bulkSelectRows.forEach(function (el) {
                    ...
                    rowCheck.setAttribute(
                      "checked",
                      _this.element.attr("checked")
                    );
                  });
                });
              },
              ...
              value: function clickRowCheckbox() {
                ...
                this.bulkSelectRows.forEach(function (el) {
                  ...
                  rowCheck.on("click", function () {
                    if (
                      _this2.element.attr("indeterminate") !== "indeterminate"
                    ) {
        ...
        var events = [
          {
            ...
            start: ""
              .concat(currentYear, "-")
              .concat(currentMonth, "-01 10:00:00"),
            end: ""
              .concat(currentYear, "-")
              .concat(currentMonth, "-03 16:00:00"),
            description:
          ...
          },
          {
            ...
            start: ""
              .concat(currentYear, "-")
              .concat(currentMonth, "-16 10:00:00"),
            description: "ICT Expo ".concat(
              ...
              .concat(currentYear, "-")
              .concat(currentMonth, "-18 16:00:00"),
          ...
          },
          {
            ...
            start: ""
              .concat(currentYear, "-")
              .concat(currentMonth, "-07 10:00:00"),
            description:
          ...
          },
          {
            ...
            start: ""
              .concat(currentYear, "-")
              .concat(currentMonth, "-14 10:00:00"),
            description:
    ...
    \****************************************/
      /***/ (
        ...
        /* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./events */ "./resources/js/calendar/events.js"
          );
        /* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./template */ "./resources/js/calendar/template.js"
          );
        /* harmony import */ var _fullcalendar__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ../fullcalendar */ "./resources/js/fullcalendar.js"
          );
  ...
  -----------------------------------------------*/
        ...
        var appCalendarInit = function appCalendarInit() {
          ...
          var eventList = _events__WEBPACK_IMPORTED_MODULE_1__[
            "default"
          ...
          if (appCalendar) {
            var calendar = (0,
            _fullcalendar__WEBPACK_IMPORTED_MODULE_3__.renderCalendar)(
              appCalendar,
              {
                headerToolbar: false,
                dayMaxEvents: 2,
                ...
                eventClick: function eventClick(info) {
                  if (info.event.url) {
                    ...
                    var template = (0,
                    _template__WEBPACK_IMPORTED_MODULE_2__["default"])(
                      info.event
                    );
            ...
            document
              ...
              .forEach(function (button) {
                button.addEventListener(Events.CLICK, function (e) {
                  ...
                  var type = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                    el,
                    DataKeys.EVENT
                  );
            ...
            document
              ...
              .forEach(function (link) {
                link.addEventListener(Events.CLICK, function (e) {
                  ...
                  calendar.changeView(
                    _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                      el,
                      DataKeys.FC_VIEW
                    )
                  );
    ...
    \******************************************************/
      /***/ (
        ...
        /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ../utils */ "./resources/js/utils.js");
        /* harmony import */ var _management_events__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./management-events */ "./resources/js/calendar/management-events.js"
          );
        /* harmony import */ var _fullcalendar__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../fullcalendar */ "./resources/js/fullcalendar.js"
          );
        /* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./template */ "./resources/js/calendar/template.js"
          );
  ...
  -----------------------------------------------*/
        ...
        var managementCalendarInit = function managementCalendarInit() {
          ...
          if (managementCalendar) {
            var calendarData = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
              managementCalendar,
              "calendar-option"
            );
            ...
            var addEventForm = document.querySelector(Selectors.ADD_EVENT_FORM);
            var addEventModal = document.querySelector(
              Selectors.ADD_EVENT_MODAL
            );
            var eventDetailsModal = document.querySelector(
              Selectors.EVENT_DETAILS_MODAL
            );
            ...
            if (_management_events__WEBPACK_IMPORTED_MODULE_1__["default"]) {
              _management_events__WEBPACK_IMPORTED_MODULE_1__[
                "default"
              ].forEach(function (e) {
            ...
            if (eventManagementInfo) {
              eventManagementInfo.forEach(function (li, index) {
                li.addEventListener(Events.CLICK, function () {
                  var event =
                    _management_events__WEBPACK_IMPORTED_MODULE_1__["default"][
                      index
                    ];
                  var template = (0,
                  _template__WEBPACK_IMPORTED_MODULE_3__["default"])(event);
                  document.querySelector(
                    Selectors.EVENT_DETAILS_MODAL_CONTENT
                  ).innerHTML = template;
                  var modal = new window.bootstrap.Modal(eventDetailsModal);
            ...
            if (managementCalendar) {
              var calendar = (0,
              _fullcalendar__WEBPACK_IMPORTED_MODULE_2__.renderCalendar)(
                managementCalendar,
                {
                  headerToolbar: false,
                  dayMaxEvents: 2,
    ...
    \****************************************************/
      /***/ (
        ...
        var plus2Day =
          window.dayjs && window.dayjs().add(2, "day").format("DD");
    ...
    \**************************************************/
      /***/ (
        ...
        /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ../../utils */ "./resources/js/utils.js");
        /* harmony import */ var _chartjs_utils__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./chartjs-utils */ "./resources/js/charts/chartjs/chartjs-utils.js"
          );
        ...
        var barChartInit = function barChartInit() {
          ...
          var getOptions = function getOptions() {
            return {
                ...
                datasets: [
                  {
                    ...
                    data: [12, 19, 3, 5, 6, 3],
                    backgroundColor: [
                      _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor(
                          "secondary"
                        ),
                        0.2
                      ),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("warning"),
                        0.2
                      ),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("info"),
                        0.2
                      ),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("success"),
                        0.2
                      ),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("info"),
                      ...
                      _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("primary"),
                        0.2
                      ),
                    ],
                    borderColor: [
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("secondary"),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("warning"),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("info"),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("success"),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("info"),
              ...
              options: {
                plugins: {
                  tooltip: (0,
                  _chartjs_utils__WEBPACK_IMPORTED_MODULE_1__.chartJsDefaultTooltip)(),
                },
                scales: {
                  x: {
                    grid: {
                      color: _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays()["black"],
                        0.1
                      ),
                    },
                  },
          ...
          (0, _chartjs_utils__WEBPACK_IMPORTED_MODULE_1__.chartJsInit)(
            barChartElement,
            getOptions
          );
        };
                ...
                datasets: [
                  {
                    label: "Dataset 1",
                    data: (0,
                    _chartjs_utils__WEBPACK_IMPORTED_MODULE_1__.getBubbleDataset)(
                      5,
                      5,
                      15,
                      0,
                    ...
                    backgroundColor:
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getSoftColors()[
                        "primary"
                      ],
                    hoverBackgroundColor:
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColors()[
                        "primary"
                      ],
                  },
                  {
                  ...
                  },
                  {
                    ...
                    hoverBackgroundColor:
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColors()["danger"],
                  },
                ],
              },
              options: {
                ...
                datasets: [
                  {
                    ...
                    backgroundColor: [
                      ...
                      _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("youtube"),
                        0.2
                      ),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("twitter"),
                        0.2
                      ),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor(
                      ...
                      _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("github"),
                        0.2
                      ),
                    ],
                    borderWidth: 1,
                    borderColor: [
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("facebook"),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("youtube"),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("twitter"),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("linkedin"),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("github"),
                    ],
                  },
                ],
                ...
                datasets: [
                  {
                    ...
                    borderWidth: 1,
                    borderColor:
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays()["100"],
                  },
                ],
                labels: [
                  "Facebook",
                ...
                datasets: [
                  {
                    ...
                    borderWidth: 1,
                    borderColor:
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays()["400"],
                  },
                ],
                labels: [
                  "Facebook",
    ...
    \******************************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ chartJsDefaultTooltip: () =>
            /* binding */ chartJsDefaultTooltip,
          /* harmony export */ chartJsInit: () => /* binding */ chartJsInit,
          /* harmony export */ getBubbleDataset: () =>
            /* binding */ getBubbleDataset,
          /* harmony export */
        });
        /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ../../utils */ "./resources/js/utils.js");
        ...
        var getBubbleDataset = function getBubbleDataset(
          count,
          rmin,
          rmax,
          min,
          ...
          return arr.map(function () {
            return {
              ...
              r: _utils__WEBPACK_IMPORTED_MODULE_0__.getRandomNumber(
                rmin,
                rmax
              ),
            };
    ...
    \***************************************************************/
      /***/ (
        ...
        var productShareDoughnutInit = function productShareDoughnutInit() {
                ...
                datasets: [
                  {
                    ...
                    backgroundColor: [
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("primary"),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("300"),
                    ],
                    borderColor: [
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("primary"),
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("300"),
          ...
          (0, _chartjs_utils__WEBPACK_IMPORTED_MODULE_1__.chartJsInit)(
            marketShareDoughnutElement,
            getOptions
          );
        };

        /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
          productShareDoughnutInit;
    ...
    \************************************************************/
      /***/ (
        ...
        /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ../../utils */ "./resources/js/utils.js");
        /* harmony import */ var _echarts_utils__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./echarts-utils */ "./resources/js/charts/echarts/echarts-utils.js"
          );
        ...
        var activeUsersChartReportInit = function activeUsersChartReportInit() {
          ...
          if ($echartsActiveUsersChart) {
            var userOptions = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
              $echartsActiveUsersChart,
              "options"
            );
              ...
              return {
                ...
                tooltip: {
                  ...
                  backgroundColor:
                    _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays()["100"],
                  borderColor:
                    _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays()["300"],
                  textStyle: {
                  ...
                  position: function position(pos, params, dom, rect, size) {
                    return (0,
                    _echarts_utils__WEBPACK_IMPORTED_MODULE_1__.getPosition)(
                      pos,
                      params,
                      dom,
                      rect,
                ...
                xAxis: {
                  type: "category",
                  data: _utils__WEBPACK_IMPORTED_MODULE_0__
                    .getPastDates(30)
                    .map(function (date) {
                  ...
                  axisTick: {
                    ...
                    lineStyle: {
                      color:
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays()["200"],
                    },
                    interval: 5,
                  },
                  axisLabel: {
                    color:
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays()["600"],
                ...
                series: [
                  {
                    type: "line",
                    data: [
                      4164, 4652, 4817, 4841, 4920, 5439, 5486, 5498, 5512,
                      5538, 5841, 5877, 6086, 6146, 6199, 6431, 6704, 7939,
                      8127, 8296, 8322, 8389, 8411, 8502, 8868, 8977, 9273,
                      9325, 9345, 9430,
                    ],
                    showSymbol: false,
                    symbol: "circle",
                    itemStyle: {
                      borderColor:
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColors().primary,
                      borderWidth: 2,
                    },
                    lineStyle: {
                      color:
                  ...
                  },
                  {
                    type: "line",
                    data: [
                      2164, 2292, 2386, 2430, 2528, 3045, 3255, 3295, 3481,
                      3604, 3688, 3840, 3932, 3949, 4003, 4298, 4424, 4869,
                      4922, 4973, 5155, 5267, 5566, 5689, 5692, 5758, 5773,
                      5799, 5960, 6000,
                    ],
                    showSymbol: false,
                    symbol: "circle",
                    itemStyle: {
                      borderColor:
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColors().success,
                      borderWidth: 2,
                    },
                    lineStyle: {
                      color:
                  ...
                  },
                  {
                    type: "line",
                    data: [
                      1069, 1089, 1125, 1141, 1162, 1179, 1185, 1216, 1274,
                      1322, 1346, 1395, 1439, 1564, 1581, 1590, 1656, 1815,
                      1868, 2010, 2133, 2179, 2264, 2265, 2278, 2343, 2354,
                      2456, 2472, 2480,
                    ],
                    showSymbol: false,
                    symbol: "circle",
                    itemStyle: {
                      borderColor:
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColors().info,
                      borderWidth: 2,
                    },
                    lineStyle: {
                      color:
            ...
            (0, _echarts_utils__WEBPACK_IMPORTED_MODULE_1__.echartSetOption)(
              chart,
              userOptions,
              getDefaultOptions
            );
        ...
        var audienceChartInit = function audienceChartInit() {
          ...
          var tooltipFormatter = function tooltipFormatter(params) {
            ...
            return "<div>\n          <p class='mb-0 fs--2 text-600'>"
              .concat(
                window.dayjs(params[0].axisValue).format("MMM DD"),
                " vs "
              )
              .concat(
        ...
        var bandwidthSavedInit = function bandwidthSavedInit() {
          ...
          if ($echartsBandwidthSaved) {
                ...
                series: [
                  {
                    ...
                    axisLine: {
                      lineStyle: {
                        ...
                        color: [
                          [
                            1,
                            _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("200"),
                          ],
                        ],
                      },
                    },
                    ...
                    detail: {
                      ...
                      fontFamily: "poppins",
                      color:
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("500"),
                      formatter: "{value}%",
                      valueAnimation: true,
                    },
            ...
            var initChart = function initChart() {
              if (
                _utils__WEBPACK_IMPORTED_MODULE_0__.isScrolledIntoView(
                  $echartsBandwidthSaved
                )
              ) {
                (0,
                _echarts_utils__WEBPACK_IMPORTED_MODULE_1__.echartSetOption)(
                  chart,
                  userOptions,
                  getDefaultOptions
                );
      ...
      /***/ (
        ...
        var basicEchartsInit = function basicEchartsInit() {
          ...
          $echartBasicCharts.forEach(function ($echartBasicChart) {
            ...
            (0,
            _echarts_utils__WEBPACK_IMPORTED_MODULE_1__.echartSetOption)(chart, userOptions, getDefaultOptions);
          });
        };
    ...
    \****************************************************/
      /***/ (
        ...
        var bounceRateChartInit = function bounceRateChartInit() {
          var $echartsBounceRateChart = document.querySelector(
            ".echart-bounce-rate"
          );
            ...
            var getDefaultOptions = function getDefaultOptions() {
              return {
                ...
                title: {
                  ...
                  textStyle: {
                    color:
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays()["900"],
                    fontSize: 13,
                    fontWeight: 600,
                  },
                },
                ...
                series: [
                  {
                    type: "line",
                    data: [
                      40, 37, 42, 44, 36, 39, 37, 43, 38, 35, 43, 39, 42, 36,
                      37, 36, 42, 44, 34, 41, 37, 41, 40, 40, 43, 34, 41, 35,
                      44, 41, 40,
                    ],
                    showSymbol: false,
                    symbol: "circle",
      ...
      /***/ (
        ...
        var candleChartInit = function candleChartInit() {
          ...
          if ($echartsCandleChart) {
            ...
            var warning =
              _utils__WEBPACK_IMPORTED_MODULE_0__.getColors()["warning"];
            var primary =
              _utils__WEBPACK_IMPORTED_MODULE_0__.getColors()["primary"];
            ...
            var getDefaultOptions = function getDefaultOptions() {
              return {
                ...
                tooltip: {
                  ...
                  borderWidth: 1,
                  formatter:
                    _echarts_utils__WEBPACK_IMPORTED_MODULE_1__.tooltipFormatter,
                  transitionDuration: 0,
                  position: function position(pos, params, dom, rect, size) {
                    return (0,
                    _echarts_utils__WEBPACK_IMPORTED_MODULE_1__.getPosition)(
                ...
                legend: {
                  ...
                  textStyle: {
                    color:
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays()["700"],
                  },
                  itemGap: 20,
                },
                xAxis: {
                ...
                series: [
                  ...
                  },
                  {
                    ...
                    name: "Revenue Date",
                    data: [
                      0, 10000, 24000, 35000, 45000, 53000, 57000, 68000, 79000,
                    ],
                    symbolSize: 5,
                    symbol: "circle",
                    smooth: false,
    ...
    \****************************************************/
      /***/ (
        ...
        var revenueChartInit = function revenueChartInit() {
          var data = {
            dates: _utils__WEBPACK_IMPORTED_MODULE_0__.getDates(
              new Date("5-6-2019"),
              new Date("5-6-2021"),
              1000 * 60 * 60 * 24 * 30
            ),
    ...
    \******************************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ echartSetOption: () =>
            /* binding */ echartSetOption,
          /* harmony export */ getPosition: () => /* binding */ getPosition,
          /* harmony export */ tooltipFormatter: () =>
            /* binding */ tooltipFormatter,
          /* harmony export */
        });
      ...
      /***/ (
        ...
        var echarstInit = function echarstInit() {
          var resizeEcharts = function resizeEcharts() {
            var $echarts = document.querySelectorAll(
    ...
    \******************************************************/
      /***/ (
        ...
        var grossRevenueChartInit = function grossRevenueChartInit() {
          ...
          var $echartsGrossRevenue =
            document.querySelector(ECHART_GROSS_REVENUE);
          var months = [
            "Jan",
            "Feb",
            "Mar",
          ...
          if ($echartsGrossRevenue) {
            ...
            var dates = function dates(month) {
              return _utils__WEBPACK_IMPORTED_MODULE_0__.getDates(
    ...
    \********************************************************/
      /***/ (
        ...
        var leadConversionInit = function leadConversionInit() {
          var $leadConversion = document.querySelector(
            ...
            var getDefaultOptions = function getDefaultOptions() {
              return {
                color: [
                  ...
                  _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                    _utils__WEBPACK_IMPORTED_MODULE_0__.getColors().secondary,
                    0.2
                  ),
                  _utils__WEBPACK_IMPORTED_MODULE_0__.rgbaColor(
                    _utils__WEBPACK_IMPORTED_MODULE_0__.getColors().warning,
                    ...
                    itemStyle: {
                      color:
                        localStorage.getItem("theme") === "light"
                          ? _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays()[
                              "white"
                            ]
                          : _utils__WEBPACK_IMPORTED_MODULE_0__.getColors()
                              .primary,
    ...
    \***************************************************************/
      /***/ (
        ...
        var marketShareEcommerceInit = function marketShareEcommerceInit() {
          ...
          var $echartProductShare =
            document.querySelector(ECHART_PRODUCT_SHARE);
                ...
                series: [
                  {
                    ...
                    itemStyle: {
                      borderWidth: 2,
                      borderColor:
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("card-bg"),
                    },
                    label: {
                      normal: {
                        show: false,
            ...
            var getDefaultOptions = function getDefaultOptions() {
              return {
                color: [
                  ...
                  _utils__WEBPACK_IMPORTED_MODULE_0__.getColors().info,
                  _utils__WEBPACK_IMPORTED_MODULE_0__.getColors().warning,
                  _utils__WEBPACK_IMPORTED_MODULE_0__.getColors().info, // utils.getGrays()[300],
                ],
                tooltip: {
                  trigger: "item",
                  padding: [7, 10],
        ...
        var realTimeUsersChartInit = function realTimeUsersChartInit() {
          ...
          if ($echartsRealTimeUsers) {
            ...
            setInterval(function () {
              var rndData = _utils__WEBPACK_IMPORTED_MODULE_0__.getRandomNumber(
                900,
                1000
              );
              data.shift();
              ...
              axisData.shift();
              axisData.push(
                _utils__WEBPACK_IMPORTED_MODULE_0__.getRandomNumber(100, 500)
              );
    ...
    \*************************************************************/
      /***/ (
        ...
        var reportForThisWeekInit = function reportForThisWeekInit() {
          var ECHART_BAR_REPORT_FOR_THIS_WEEK =
            ".echart-bar-report-for-this-week";
          ...
          if ($echartBarReportForThisWeek) {
            var selectChart = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
              $echartBarReportForThisWeek,
              "chart"
            );
            ...
            var getDefaultOptions = function getDefaultOptions() {
              return {
                tooltip: {
                  ...
                  padding: [7, 10],
                  backgroundColor:
                    _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("100"),
                  borderColor:
                    _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("300"),
                  textStyle: {
                    color: _utils__WEBPACK_IMPORTED_MODULE_0__.getColors().dark,
                ...
                radar: {
                  ...
                  name: {
                    textStyle: {
                      color:
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("600"),
                      fontWeight: 500,
                    },
                  },
                  indicator: [
      ...
      /***/ (
        ...
        var totalOrderInit = function totalOrderInit() {
          ...
          var $echartLineTotalOrder = document.querySelector(
            ECHART_LINE_TOTAL_ORDER
          );

          if ($echartLineTotalOrder) {
            // Get options from data attribute
            var userOptions = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
              $echartLineTotalOrder,
              "options"
            );
                ...
                series: [
                  {
                    ...
                    itemStyle: {
                      color:
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays().white,
                      borderColor:
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColors().primary,
                      borderWidth: 2,
                    },
    ...
    \**************************************************************/
      /***/ (
        ...
        var totalSalesEcommerce = function totalSalesEcommerce() {
          var ECHART_LINE_TOTAL_SALES_ECOMM =
            ...
            return params
              .map(function (_ref, index) {
                ...
                return '<span class= "fas fa-circle" style="color: '
                  ...
                  .concat(index === 0 ? "Last Month" : "Previous Year", ": ")
                  .concat(value, "</span>");
              })
              .join("<br/>");
          }
    ...
    \*********************************************************/
      /***/ (
        ...
        var trafficChannelChartInit = function trafficChannelChartInit() {
          var $trafficChannels = document.querySelector(
          ...
          for (var i = 0; i < 24; i += 1) {
            for (var j = 0; j < 7; j += 1) {
              data.push([
                j,
                i,
                _utils__WEBPACK_IMPORTED_MODULE_0__.getRandomNumber(20, 300),
              ]);
            }
          }
                ...
                series: [
                  {
                    ...
                    itemStyle: {
                      borderColor:
                        _utils__WEBPACK_IMPORTED_MODULE_0__.getColor("white"),
                      borderWidth: 3,
                    },
                    emphasis: {
                      itemStyle: {
  ...
  -----------------------------------------------*/
        ...
        var chatInit = function chatInit() {
          ...
          document
            .querySelectorAll(Selector.CHAT_CONTACT)
            .forEach(function (el) {
          ...
          $chatEmojiarea &&
            document.querySelectorAll(Selector.BTN_INFO).forEach(function (el) {
              el.addEventListener(Events.CLICK, function (e) {
                var $this = e.currentTarget;
                var dataIndex = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                  $this,
                  DATA_KEY.INDEX
                );
          ...
          $chatEmojiarea &&
            window.picker.on(Events.EMOJI, function (selection) {
  ...
  -----------------------------------------------*/
        ...
        var cookieNoticeInit = function cookieNoticeInit() {
          ...
          notices.forEach(function (item) {
            ...
            if (showOnce) {
              var hasNotice =
                _utils__WEBPACK_IMPORTED_MODULE_0__.getCookie("notice");
            ...
            item.addEventListener(Events.HIDDEN_BS_TOAST, function (e) {
              ...
              toastOptions.showOnce &&
                _utils__WEBPACK_IMPORTED_MODULE_0__.setCookie(
                  "notice",
                  false,
                  toastOptions.cookieExpireTime
                );
            });
          });
          var btnNoticeToggle = document.querySelector(
            Selector.DATA_TOGGLE_Notice
          );
          btnNoticeToggle &&
            btnNoticeToggle.addEventListener(Events.CLICK, function (_ref) {
              var currentTarget = _ref.currentTarget;
              var id = currentTarget.getAttribute("href");
              var notice = new window.bootstrap.Toast(
                document.querySelector(id)
              );
              /*eslint-disable-next-line*/

              var el = notice._element;
              _utils__WEBPACK_IMPORTED_MODULE_0__.hasClass(el, ClassNames.HIDE)
                ? notice.show()
                : notice.hide();
            });
        };
          ...
          copyButtons &&
            copyButtons.forEach(function (button) {
              ...
              button.addEventListener("click", function (e) {
                ...
                tooltip.update();
                var inputID = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                  el,
                  "copy"
                );
        ...
        var countupInit = function countupInit() {
          if (window.countUp) {
            ...
            countups.forEach(function (node) {
              var _utils$getData = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                  node,
                  "countup"
                ),
    ...
    \**********************************/
      /***/ (
        ...
        var detectorInit = function detectorInit() {
          ...
          is.opera() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "opera");
          is.mobile() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "mobile");
          is.firefox() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "firefox");
          is.safari() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "safari");
          is.ios() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "ios");
          is.iphone() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "iphone");
          is.ipad() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "ipad");
          is.ie() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "ie");
          is.edge() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "edge");
          is.chrome() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "chrome");
          is.mac() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "osx");
          is.windows() &&
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.addClass)(html, "windows");
        ...
        var draggableInit = function draggableInit() {
          ...
          if (!!columnContainers.length) {
            ...
            var sortable = new window.Draggable.Sortable(columnContainers, {
              ...
              scrollable: {
                draggable: Selectors.KANBAN_ITEM,
                scrollableElements: [].concat(
                  _toConsumableArray(columnContainers),
                  [container]
                ),
              },
            ...
            sortable.on(Events.DRAG_START, function () {
              columns.forEach(function (column) {
                _utils__WEBPACK_IMPORTED_MODULE_0__.hasClass(
                  column,
            ...
            sortable.on(Events.DRAG_STOP, function (_ref) {
              ...
              var columnContainer = el.closest(
                Selectors.KANBAN_ITEMS_CONTAINER
              );
  ...
  -----------------------------------------------*/
                    ...
                    thisDropzone.on(Events.ADDED_FILE, function addedfile() {
                      if ("maxFiles" in userOptions) {
                        if (
                          ...
                          item.querySelectorAll(Selector.DZ_PREVIEW_COVER)
                            .length > 1
                        ) {
                          item
    ...
    \**************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ fullCalendarInit: () =>
            /* binding */ fullCalendarInit,
          /* harmony export */ renderCalendar: () =>
            /* binding */ renderCalendar,
          /* harmony export */
        });
        /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./utils */ "./resources/js/utils.js");
        ...
        var fullCalendarInit = function fullCalendarInit() {
          ...
          calendars.forEach(function (item) {
            var options = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
              item,
              "calendar"
            );
  ...
  -----------------------------------------------*/
        ...
        function initMap() {
          ...
          if ($googlemaps.length && window.google) {
            ...
            $googlemaps.forEach(function (itm) {
              var latLng = _utils__WEBPACK_IMPORTED_MODULE_0__
                .getData(itm, "latlng")
                .split(",");
              var markerPopup = itm.innerHTML;
              var icon = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                itm,
                "icon"
              )
                ? _utils__WEBPACK_IMPORTED_MODULE_0__.getData(itm, "icon")
                : "https://maps.gstatic.com/mapfiles/api-3/images/spotlight-poi.png";
              var zoom = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                itm,
                "zoom"
              );
              var mapElement = itm;
              var mapStyle = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                itm,
                "theme"
              );

              if (
                _utils__WEBPACK_IMPORTED_MODULE_0__.getData(itm, "theme") ===
                "streetview"
              ) {
                var pov = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                  itm,
                  "pov"
                );
                var _mapOptions = {
              ...
              var mapOptions = {
                zoom: zoom,
                scrollwheel: _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                  itm,
                  "scrollwheel"
                ),
    ...
    \*******************************/
      /***/ (
        ...
        var iconCopiedInit = function iconCopiedInit() {
          ...
          var iconCopiedToastInstance = new window.bootstrap.Toast(
            iconCopiedToast
          );
    ...
    \********************************/
      /***/ (
        ...
        var kanbanInit = function kanbanInit() {
          ...
          var addCardButtons = document.querySelectorAll(
            Selectors.BTN_ADD_CARD
          );
          var formHideButtons = document.querySelectorAll(
            Selectors.BTN_FORM_HIDE
          );
    ...
    \******************************/
      /***/ (
        ...
        var togglePaginationButtonDisable =
      ...
      /***/ (
        ...
        var navbarComboInit = function navbarComboInit() {
          ...
          var navbarTopCombo = document.querySelector(
            Selector.NAVBAR_TOP_COMBO
          );

          var moveNavContent = function moveNavContent(windowWidth) {
            var navbarVerticalBreakpoint =
              _utils__WEBPACK_IMPORTED_MODULE_0__.getBreakpoint(navbarVertical);
            var navbarTopBreakpoint =
              _utils__WEBPACK_IMPORTED_MODULE_0__.getBreakpoint(navbarTopCombo);
            ...
            if (windowWidth < navbarTopBreakpoint) {
              ...
              if (navbarTopContent) {
                var targetID = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                  navbarTopCombo,
                  "move-target"
                );
                ...
                if (navbarVerticalBreakpoint < navbarTopBreakpoint) {
                  ...
                  _utils__WEBPACK_IMPORTED_MODULE_0__.addClass(
                    navbarNav,
        ...
        var navbarDarkenOnScroll = function navbarDarkenOnScroll() {
          ...
          function getBgClassName(name, defaultColorName) {
            ...
            var allColors = _objectSpread(
              _objectSpread(
                {},
                _utils__WEBPACK_IMPORTED_MODULE_0__.getColors(parent)
              ),
              _utils__WEBPACK_IMPORTED_MODULE_0__.getGrays(parent)
            );
          ...
          if (navbar) {
            ...
            var name = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
              navbar,
              DataKey.NAVBAR_DARKEN_ON_SCROLL
            );
            ...
            var colorRgb = _utils__WEBPACK_IMPORTED_MODULE_0__.hexToRgb(
            ...
            _utils__WEBPACK_IMPORTED_MODULE_0__.resize(function () {
              var breakPoint =
                _utils__WEBPACK_IMPORTED_MODULE_0__.getBreakpoint(navbar);
    ...
    \************************************/
      /***/ (
        ...
        var navbarTopDropShadow = function navbarTopDropShadow() {
          ...
          var $navbar = document.querySelector(Selector.NAVBAR);
          var $navbarVertical = document.querySelector(
          ...
          var setDropShadow = function setDropShadow($elem) {
            if ($elem.scrollTop > 0 && navDropShadowFlag) {
              ...
              $navbar &&
                $navbar.classList.remove(ClassNames.NAVBAR_GLASS_SHADOW);
            }
          };
    ...
    \*****************************************/
      /***/ (
        ...
        var handleNavbarVerticalCollapsed =
          function handleNavbarVerticalCollapsed() {
            ...
            var ClassNames = {
              ...
              NAVBAR_VERTICAL_COLLAPSED_HOVER:
            ...
            if (navbarVerticalToggle) {
              navbarVerticalToggle.addEventListener(Events.CLICK, function (e) {
                ...
                var isNavbarVerticalCollapsed =
                  _utils__WEBPACK_IMPORTED_MODULE_0__.getItemFromStore(
                    "isNavbarVerticalCollapsed"
                  );
                _utils__WEBPACK_IMPORTED_MODULE_0__.setItemToStore(
                  "isNavbarVerticalCollapsed",
                  !isNavbarVerticalCollapsed
                );
        ...
        var progressAnimationToggle = function progressAnimationToggle() {
          ...
          animatedProgress.forEach(function (progress) {
            progress.addEventListener("click", function (e) {
              var progressID = _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                e.currentTarget,
                "progressAnimation"
              );
  ...
  -----------------------------------------------*/
        ...
        var quantityInit = function quantityInit() {
          ...
          var quantities = document.querySelectorAll(
            Selector.DATA_QUANTITY_BTN
          );
        ...
        var ratingInit = function ratingInit() {
          ...
          raters.forEach(function (rater) {
            var options = _objectSpread(
              {
                reverse:
                  _utils__WEBPACK_IMPORTED_MODULE_0__.getItemFromStore("isRTL"),
                starSize: 32,
                step: 0.5,
                element: rater,
                  ...
                  top:
                    (_utils$getData =
                      _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                        el,
                        "offset-top"
                      )) !== null && _utils$getData !== void 0
                      ? _utils$getData
                      : _utils__WEBPACK_IMPORTED_MODULE_0__.getOffset(
                          document.querySelector(id)
                        ).top - 100,
                  left: 0,
                  behavior: "smooth",
      ...
      /***/ (
        ...
        var searchInit = function searchInit() {
          ...
          var hideSearchSuggestion = function hideSearchSuggestion(searchArea) {
            ...
            var dropdownMenu = searchArea.querySelector(
  ...
  -----------------------------------------------*/
    ...
    \***************************************/
      /***/ (
        ...
        /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./utils */ "./resources/js/utils.js");
        /* harmony import */ var _node__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./node */ "./resources/js/node.js");
        ...
        var initialDomSetup = function initialDomSetup(element) {
          ...
          var hasDataUrl = dataUrlDom
            ? (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getData)(
                dataUrlDom,
                "page-url"
              )
            : null;
          element
            ...
            .forEach(function (el) {
              var inputDataAttributeValue = (0,
              _utils__WEBPACK_IMPORTED_MODULE_0__.getData)(el, "theme-control");
              ...
              if (
                ...
                !hasDataUrl &&
                (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getItemFromStore)(
                  "navbarPosition"
                ) === "top"
              ) {
        ...
        var themeControl = function themeControl() {
          var themeController = new _node__WEBPACK_IMPORTED_MODULE_1__[
            "default"
          ](document.body);
          var navbarVertical = document.querySelector(".navbar-vertical");
          initialDomSetup(themeController.node);
          themeController.on("click", function (e) {
            var target = new _node__WEBPACK_IMPORTED_MODULE_1__["default"](
              e.target
            );
            ...
            if (target.data("theme-control")) {
              ...
              var value =
                e.target[e.target.type === "radio" ? "value" : "checked"];
              ...
              (0, _utils__WEBPACK_IMPORTED_MODULE_0__.setItemToStore)(
                control,
                value
              );
                ...
                case "reset": {
                  Object.keys(
                    ...
                    localStorage.setItem(
                      key,
                      _config__WEBPACK_IMPORTED_MODULE_2__["default"][key]
                    );
                  });
                  window.location.reload();
                  break;
          ...
          if (window.tinymce) {
            ...
            if (tinymces.length) {
              window.tinymce.init({
                ...
                height: "50vh",
                menubar: false,
                skin: _utils__WEBPACK_IMPORTED_MODULE_0__.settings.tinymce
                  .theme,
      ...
      /***/ (
        ...
        var treeviewInit = function treeviewInit() {
          ...
          var makeStriped = function makeStriped(treeview) {
            var tags = Array.from(
              treeview.querySelectorAll(Selector.TREEVIEW_ROW)
            );
                ...
                collapse.addEventListener(
                  ...
                  function (e) {
                    ...
                    if (striped) {
                      ...
                      var childs = e.path[2].querySelectorAll(
          ...
          if (typedTexts.length && window.Typed) {
            typedTexts.forEach(function (typedText) {
              return new window.Typed(typedText, {
                strings: _utils__WEBPACK_IMPORTED_MODULE_0__.getData(
                  typedText,
                  "typedText"
                ),
                typeSpeed: 100,
    ...
    \*******************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ getItemFromStore: () =>
            /* binding */ getItemFromStore,
          /* harmony export */ getOffset: () => /* binding */ getOffset,
          /* harmony export */ getPastDates: () => /* binding */ getPastDates,
          /* harmony export */ getRandomNumber: () =>
            /* binding */ getRandomNumber,
          /* harmony export */ getSoftColors: () => /* binding */ getSoftColors,
          /* harmony export */ getStoreSpace: () => /* binding */ getStoreSpace,
          /* harmony export */ hasClass: () => /* binding */ hasClass,
          /* harmony export */ hexToRgb: () => /* binding */ hexToRgb,
          /* harmony export */ isIterableArray: () =>
            /* binding */ isIterableArray,
          /* harmony export */ isScrolledIntoView: () =>
            /* binding */ isScrolledIntoView,
          /* harmony export */ newChart: () => /* binding */ newChart,
          /* harmony export */ resize: () => /* binding */ resize,
          /* harmony export */ rgbaColor: () => /* binding */ rgbaColor,
          /* harmony export */ setCookie: () => /* binding */ setCookie,
          /* harmony export */ setItemToStore: () =>
            /* binding */ setItemToStore,
    ...
    \********************************/
      /***/ (
        ...
        var wizardInit = function wizardInit() {
          ...
          var tabProgressBar = document.querySelector(
            ".theme-wizard .progress"
          );
          wizards.forEach(function (wizard) {
            var tabToggleButtonEl =
              wizard.querySelectorAll("[data-wizard-step]");
            var inputEmail = wizard.querySelector(
              "[data-wizard-validate-email]"
            );
  ...
  (() => {
    ...
    /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(/*! ./utils */ "./resources/js/utils.js");
    /* harmony import */ var _navbar_vertical__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(
        /*! ./navbar-vertical */ "./resources/js/navbar-vertical.js"
      );
    /* harmony import */ var _detector__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(/*! ./detector */ "./resources/js/detector.js");
    /* harmony import */ var _tooltip__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(/*! ./tooltip */ "./resources/js/tooltip.js");
    /* harmony import */ var _popover__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(/*! ./popover */ "./resources/js/popover.js");
    /* harmony import */ var _navbar_top__WEBPACK_IMPORTED_MODULE_5__ =
      __webpack_require__(/*! ./navbar-top */ "./resources/js/navbar-top.js");
    /* harmony import */ var _toast__WEBPACK_IMPORTED_MODULE_6__ =
      __webpack_require__(/*! ./toast */ "./resources/js/toast.js");
    /* harmony import */ var _progress__WEBPACK_IMPORTED_MODULE_7__ =
      __webpack_require__(/*! ./progress */ "./resources/js/progress.js");
    /* harmony import */ var _glightbox__WEBPACK_IMPORTED_MODULE_8__ =
      __webpack_require__(/*! ./glightbox */ "./resources/js/glightbox.js");
    /* harmony import */ var _plyr__WEBPACK_IMPORTED_MODULE_9__ =
      __webpack_require__(/*! ./plyr */ "./resources/js/plyr.js");
    /* harmony import */ var _googleMap__WEBPACK_IMPORTED_MODULE_10__ =
      __webpack_require__(/*! ./googleMap */ "./resources/js/googleMap.js");
    /* harmony import */ var _dropzone__WEBPACK_IMPORTED_MODULE_11__ =
      __webpack_require__(/*! ./dropzone */ "./resources/js/dropzone.js");
    /* harmony import */ var _choices__WEBPACK_IMPORTED_MODULE_12__ =
      __webpack_require__(/*! ./choices */ "./resources/js/choices.js");
    /* harmony import */ var _charts_chartjs_chart_bar__WEBPACK_IMPORTED_MODULE_13__ =
      __webpack_require__(
        /*! ./charts/chartjs/chart-bar */ "./resources/js/charts/chartjs/chart-bar.js"
      );
    /* harmony import */ var _form_validation__WEBPACK_IMPORTED_MODULE_14__ =
      __webpack_require__(
        /*! ./form-validation */ "./resources/js/form-validation.js"
      );
    /* harmony import */ var _leaflet_active_user__WEBPACK_IMPORTED_MODULE_15__ =
      __webpack_require__(
        /*! ./leaflet-active-user */ "./resources/js/leaflet-active-user.js"
      );
    /* harmony import */ var _countup__WEBPACK_IMPORTED_MODULE_16__ =
      __webpack_require__(/*! ./countup */ "./resources/js/countup.js");
    /* harmony import */ var _copy_link__WEBPACK_IMPORTED_MODULE_17__ =
      __webpack_require__(/*! ./copy-link */ "./resources/js/copy-link.js");
    /* harmony import */ var _typed__WEBPACK_IMPORTED_MODULE_18__ =
      __webpack_require__(/*! ./typed */ "./resources/js/typed.js");
    /* harmony import */ var _navbar_darken_on_scroll__WEBPACK_IMPORTED_MODULE_19__ =
      __webpack_require__(
        /*! ./navbar-darken-on-scroll */ "./resources/js/navbar-darken-on-scroll.js"
      );
    /* harmony import */ var _scroll_to_top__WEBPACK_IMPORTED_MODULE_20__ =
      __webpack_require__(
        /*! ./scroll-to-top */ "./resources/js/scroll-to-top.js"
      );
    /* harmony import */ var _tinymce__WEBPACK_IMPORTED_MODULE_21__ =
      __webpack_require__(/*! ./tinymce */ "./resources/js/tinymce.js");
    /* harmony import */ var _bulk_select__WEBPACK_IMPORTED_MODULE_22__ =
      __webpack_require__(/*! ./bulk-select */ "./resources/js/bulk-select.js");
    /* harmony import */ var _quantity__WEBPACK_IMPORTED_MODULE_23__ =
      __webpack_require__(/*! ./quantity */ "./resources/js/quantity.js");
    /* harmony import */ var _navbar_combo__WEBPACK_IMPORTED_MODULE_24__ =
      __webpack_require__(
        /*! ./navbar-combo */ "./resources/js/navbar-combo.js"
      );
    /* harmony import */ var _list__WEBPACK_IMPORTED_MODULE_25__ =
      __webpack_require__(/*! ./list */ "./resources/js/list.js");
    /* harmony import */ var _chat__WEBPACK_IMPORTED_MODULE_26__ =
      __webpack_require__(/*! ./chat */ "./resources/js/chat.js");
    /* harmony import */ var _draggable__WEBPACK_IMPORTED_MODULE_27__ =
      __webpack_require__(/*! ./draggable */ "./resources/js/draggable.js");
    /* harmony import */ var _kanban__WEBPACK_IMPORTED_MODULE_28__ =
      __webpack_require__(/*! ./kanban */ "./resources/js/kanban.js");
    /* harmony import */ var _fullcalendar__WEBPACK_IMPORTED_MODULE_29__ =
      __webpack_require__(
        /*! ./fullcalendar */ "./resources/js/fullcalendar.js"
      );
    /* harmony import */ var _calendar_index__WEBPACK_IMPORTED_MODULE_30__ =
      __webpack_require__(
        /*! ./calendar/index */ "./resources/js/calendar/index.js"
      );
    /* harmony import */ var _calendar_management_calendar__WEBPACK_IMPORTED_MODULE_31__ =
      __webpack_require__(
        /*! ./calendar/management-calendar */ "./resources/js/calendar/management-calendar.js"
      );
    /* harmony import */ var _lottie__WEBPACK_IMPORTED_MODULE_32__ =
      __webpack_require__(/*! ./lottie */ "./resources/js/lottie.js");
    /* harmony import */ var _wizard__WEBPACK_IMPORTED_MODULE_33__ =
      __webpack_require__(/*! ./wizard */ "./resources/js/wizard.js");
    /* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_34__ =
      __webpack_require__(/*! ./swiper */ "./resources/js/swiper.js");
    /* harmony import */ var _rater__WEBPACK_IMPORTED_MODULE_35__ =
      __webpack_require__(/*! ./rater */ "./resources/js/rater.js");
    /* harmony import */ var _search__WEBPACK_IMPORTED_MODULE_36__ =
      __webpack_require__(/*! ./search */ "./resources/js/search.js");
    /* harmony import */ var _cookie_notice__WEBPACK_IMPORTED_MODULE_37__ =
      __webpack_require__(
        /*! ./cookie-notice */ "./resources/js/cookie-notice.js"
      );
    /* harmony import */ var _theme_control__WEBPACK_IMPORTED_MODULE_38__ =
      __webpack_require__(
        /*! ./theme-control */ "./resources/js/theme-control.js"
      );
    /* harmony import */ var _dropdown_on_hover__WEBPACK_IMPORTED_MODULE_39__ =
      __webpack_require__(
        /*! ./dropdown-on-hover */ "./resources/js/dropdown-on-hover.js"
      );
    /* harmony import */ var _charts_chartjs_product_share_doughnut__WEBPACK_IMPORTED_MODULE_40__ =
      __webpack_require__(
        /*! ./charts/chartjs/product-share-doughnut */ "./resources/js/charts/chartjs/product-share-doughnut.js"
      );
    /* harmony import */ var _charts_echarts_total_sales_ecommerce__WEBPACK_IMPORTED_MODULE_41__ =
      __webpack_require__(
        /*! ./charts/echarts/total-sales-ecommerce */ "./resources/js/charts/echarts/total-sales-ecommerce.js"
      );
    /* harmony import */ var _charts_echarts_sales_by_pos_location__WEBPACK_IMPORTED_MODULE_42__ =
      __webpack_require__(
        /*! ./charts/echarts/sales-by-pos-location */ "./resources/js/charts/echarts/sales-by-pos-location.js"
      );
    /* harmony import */ var _charts_echarts_returning_customer_rate__WEBPACK_IMPORTED_MODULE_43__ =
      __webpack_require__(
        /*! ./charts/echarts/returning-customer-rate */ "./resources/js/charts/echarts/returning-customer-rate.js"
      );
    /* harmony import */ var _charts_echarts_top_products__WEBPACK_IMPORTED_MODULE_44__ =
      __webpack_require__(
        /*! ./charts/echarts/top-products */ "./resources/js/charts/echarts/top-products.js"
      );
    /* harmony import */ var _charts_echarts_market_share_ecommerce__WEBPACK_IMPORTED_MODULE_45__ =
      __webpack_require__(
        /*! ./charts/echarts/market-share-ecommerce */ "./resources/js/charts/echarts/market-share-ecommerce.js"
      );
    /* harmony import */ var _charts_echarts_total_sales__WEBPACK_IMPORTED_MODULE_46__ =
      __webpack_require__(
        /*! ./charts/echarts/total-sales */ "./resources/js/charts/echarts/total-sales.js"
      );
    /* harmony import */ var _charts_echarts_weekly_sales__WEBPACK_IMPORTED_MODULE_47__ =
      __webpack_require__(
        /*! ./charts/echarts/weekly-sales */ "./resources/js/charts/echarts/weekly-sales.js"
      );
    /* harmony import */ var _charts_echarts_market_share__WEBPACK_IMPORTED_MODULE_48__ =
      __webpack_require__(
        /*! ./charts/echarts/market-share */ "./resources/js/charts/echarts/market-share.js"
      );
    /* harmony import */ var _charts_echarts_total_order__WEBPACK_IMPORTED_MODULE_49__ =
      __webpack_require__(
        /*! ./charts/echarts/total-order */ "./resources/js/charts/echarts/total-order.js"
      );
    /* harmony import */ var _charts_echarts_candle_chart__WEBPACK_IMPORTED_MODULE_50__ =
      __webpack_require__(
        /*! ./charts/echarts/candle-chart */ "./resources/js/charts/echarts/candle-chart.js"
      );
    /* harmony import */ var _charts_echarts_gross_revenue__WEBPACK_IMPORTED_MODULE_51__ =
      __webpack_require__(
        /*! ./charts/echarts/gross-revenue */ "./resources/js/charts/echarts/gross-revenue.js"
      );
    /* harmony import */ var _scrollbar__WEBPACK_IMPORTED_MODULE_52__ =
      __webpack_require__(/*! ./scrollbar */ "./resources/js/scrollbar.js");
    /* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_53__ =
      __webpack_require__(/*! ./icons */ "./resources/js/icons.js");
    /* harmony import */ var _charts_echarts_report_for_this_week__WEBPACK_IMPORTED_MODULE_54__ =
      __webpack_require__(
        /*! ./charts/echarts/report-for-this-week */ "./resources/js/charts/echarts/report-for-this-week.js"
      );
    /* harmony import */ var _charts_echarts_basic_echarts__WEBPACK_IMPORTED_MODULE_55__ =
      __webpack_require__(
        /*! ./charts/echarts/basic-echarts */ "./resources/js/charts/echarts/basic-echarts.js"
      );
    /* harmony import */ var _charts_chartjs_chart_scatter__WEBPACK_IMPORTED_MODULE_56__ =
      __webpack_require__(
        /*! ./charts/chartjs/chart-scatter */ "./resources/js/charts/chartjs/chart-scatter.js"
      );
    /* harmony import */ var _charts_chartjs_chart_doughnut__WEBPACK_IMPORTED_MODULE_57__ =
      __webpack_require__(
        /*! ./charts/chartjs/chart-doughnut */ "./resources/js/charts/chartjs/chart-doughnut.js"
      );
    /* harmony import */ var _charts_chartjs_chart_pie__WEBPACK_IMPORTED_MODULE_58__ =
      __webpack_require__(
        /*! ./charts/chartjs/chart-pie */ "./resources/js/charts/chartjs/chart-pie.js"
      );
    /* harmony import */ var _charts_chartjs_chart_polar__WEBPACK_IMPORTED_MODULE_59__ =
      __webpack_require__(
        /*! ./charts/chartjs/chart-polar */ "./resources/js/charts/chartjs/chart-polar.js"
      );
    /* harmony import */ var _charts_chartjs_chart_radar__WEBPACK_IMPORTED_MODULE_60__ =
      __webpack_require__(
        /*! ./charts/chartjs/chart-radar */ "./resources/js/charts/chartjs/chart-radar.js"
      );
    /* harmony import */ var _charts_chartjs_chart_combo__WEBPACK_IMPORTED_MODULE_61__ =
      __webpack_require__(
        /*! ./charts/chartjs/chart-combo */ "./resources/js/charts/chartjs/chart-combo.js"
      );
    /* harmony import */ var _charts_chartjs_chart_bubble__WEBPACK_IMPORTED_MODULE_62__ =
      __webpack_require__(
        /*! ./charts/chartjs/chart-bubble */ "./resources/js/charts/chartjs/chart-bubble.js"
      );
    /* harmony import */ var _dropdown_menu__WEBPACK_IMPORTED_MODULE_63__ =
      __webpack_require__(
        /*! ./dropdown-menu */ "./resources/js/dropdown-menu.js"
      );
    /* harmony import */ var _charts_echarts_audience__WEBPACK_IMPORTED_MODULE_64__ =
      __webpack_require__(
        /*! ./charts/echarts/audience */ "./resources/js/charts/echarts/audience.js"
      );
    /* harmony import */ var _charts_echarts_session_by_browser__WEBPACK_IMPORTED_MODULE_65__ =
      __webpack_require__(
        /*! ./charts/echarts/session-by-browser */ "./resources/js/charts/echarts/session-by-browser.js"
      );
    /* harmony import */ var _charts_echarts_session_by_country__WEBPACK_IMPORTED_MODULE_66__ =
      __webpack_require__(
        /*! ./charts/echarts/session-by-country */ "./resources/js/charts/echarts/session-by-country.js"
      );
    /* harmony import */ var _charts_echarts_active_users_report__WEBPACK_IMPORTED_MODULE_67__ =
      __webpack_require__(
        /*! ./charts/echarts/active-users-report */ "./resources/js/charts/echarts/active-users-report.js"
      );
    /* harmony import */ var _charts_echarts_traffic_channels__WEBPACK_IMPORTED_MODULE_68__ =
      __webpack_require__(
        /*! ./charts/echarts/traffic-channels */ "./resources/js/charts/echarts/traffic-channels.js"
      );
    /* harmony import */ var _charts_echarts_bounce_rate__WEBPACK_IMPORTED_MODULE_69__ =
      __webpack_require__(
        /*! ./charts/echarts/bounce-rate */ "./resources/js/charts/echarts/bounce-rate.js"
      );
    /* harmony import */ var _charts_echarts_users_by_time__WEBPACK_IMPORTED_MODULE_70__ =
      __webpack_require__(
        /*! ./charts/echarts/users-by-time */ "./resources/js/charts/echarts/users-by-time.js"
      );
    /* harmony import */ var _charts_echarts_session_by_country_map__WEBPACK_IMPORTED_MODULE_71__ =
      __webpack_require__(
        /*! ./charts/echarts/session-by-country-map */ "./resources/js/charts/echarts/session-by-country-map.js"
      );
    /* harmony import */ var _charts_echarts_most_leads__WEBPACK_IMPORTED_MODULE_72__ =
      __webpack_require__(
        /*! ./charts/echarts/most-leads */ "./resources/js/charts/echarts/most-leads.js"
      );
    /* harmony import */ var _charts_echarts_closed_vs_goal__WEBPACK_IMPORTED_MODULE_73__ =
      __webpack_require__(
        /*! ./charts/echarts/closed-vs-goal */ "./resources/js/charts/echarts/closed-vs-goal.js"
      );
    /* harmony import */ var _charts_echarts_lead_conversion__WEBPACK_IMPORTED_MODULE_74__ =
      __webpack_require__(
        /*! ./charts/echarts/lead-conversion */ "./resources/js/charts/echarts/lead-conversion.js"
      );
    /* harmony import */ var _charts_echarts_deal_storage_funnel__WEBPACK_IMPORTED_MODULE_75__ =
      __webpack_require__(
        /*! ./charts/echarts/deal-storage-funnel */ "./resources/js/charts/echarts/deal-storage-funnel.js"
      );
    /* harmony import */ var _charts_echarts_crm_revenue__WEBPACK_IMPORTED_MODULE_76__ =
      __webpack_require__(
        /*! ./charts/echarts/crm-revenue */ "./resources/js/charts/echarts/crm-revenue.js"
      );
    /* harmony import */ var _charts_echarts_location_by_session_crm__WEBPACK_IMPORTED_MODULE_77__ =
      __webpack_require__(
        /*! ./charts/echarts/location-by-session-crm */ "./resources/js/charts/echarts/location-by-session-crm.js"
      );
    /* harmony import */ var _charts_echarts_real_time_users__WEBPACK_IMPORTED_MODULE_78__ =
      __webpack_require__(
        /*! ./charts/echarts/real-time-users */ "./resources/js/charts/echarts/real-time-users.js"
      );
    /* harmony import */ var _charts_echarts_line_payment__WEBPACK_IMPORTED_MODULE_79__ =
      __webpack_require__(
        /*! ./charts/echarts/line-payment */ "./resources/js/charts/echarts/line-payment.js"
      );
    /* harmony import */ var _charts_chartjs_chart_line__WEBPACK_IMPORTED_MODULE_80__ =
      __webpack_require__(
        /*! ./charts/chartjs/chart-line */ "./resources/js/charts/chartjs/chart-line.js"
      );
    /* harmony import */ var _charts_echarts_bandwidth_saved__WEBPACK_IMPORTED_MODULE_81__ =
      __webpack_require__(
        /*! ./charts/echarts/bandwidth-saved */ "./resources/js/charts/echarts/bandwidth-saved.js"
      );
    /* harmony import */ var _treeview__WEBPACK_IMPORTED_MODULE_82__ =
      __webpack_require__(/*! ./treeview */ "./resources/js/treeview.js");
    /* harmony import */ var _scroll__WEBPACK_IMPORTED_MODULE_83__ =
      __webpack_require__(/*! ./scroll */ "./resources/js/scroll.js");
    /* harmony import */ var _charts_echarts_echarts__WEBPACK_IMPORTED_MODULE_84__ =
      __webpack_require__(
        /*! ./charts/echarts/echarts */ "./resources/js/charts/echarts/echarts.js"
      );
    /* harmony import */ var _anchor__WEBPACK_IMPORTED_MODULE_85__ =
      __webpack_require__(/*! ./anchor */ "./resources/js/anchor.js");
    ...
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _detector__WEBPACK_IMPORTED_MODULE_2__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _navbar_vertical__WEBPACK_IMPORTED_MODULE_1__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_total_order__WEBPACK_IMPORTED_MODULE_49__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_weekly_sales__WEBPACK_IMPORTED_MODULE_47__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_market_share__WEBPACK_IMPORTED_MODULE_48__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_total_sales__WEBPACK_IMPORTED_MODULE_46__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_top_products__WEBPACK_IMPORTED_MODULE_44__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _navbar_top__WEBPACK_IMPORTED_MODULE_5__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _tooltip__WEBPACK_IMPORTED_MODULE_3__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _popover__WEBPACK_IMPORTED_MODULE_4__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _toast__WEBPACK_IMPORTED_MODULE_6__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _progress__WEBPACK_IMPORTED_MODULE_7__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _glightbox__WEBPACK_IMPORTED_MODULE_8__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _plyr__WEBPACK_IMPORTED_MODULE_9__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _googleMap__WEBPACK_IMPORTED_MODULE_10__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _dropzone__WEBPACK_IMPORTED_MODULE_11__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _choices__WEBPACK_IMPORTED_MODULE_12__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _form_validation__WEBPACK_IMPORTED_MODULE_14__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_chartjs_chart_bar__WEBPACK_IMPORTED_MODULE_13__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _leaflet_active_user__WEBPACK_IMPORTED_MODULE_15__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _countup__WEBPACK_IMPORTED_MODULE_16__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _copy_link__WEBPACK_IMPORTED_MODULE_17__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _navbar_darken_on_scroll__WEBPACK_IMPORTED_MODULE_19__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _typed__WEBPACK_IMPORTED_MODULE_18__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _scroll_to_top__WEBPACK_IMPORTED_MODULE_20__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _tinymce__WEBPACK_IMPORTED_MODULE_21__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _bulk_select__WEBPACK_IMPORTED_MODULE_22__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _chat__WEBPACK_IMPORTED_MODULE_26__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _quantity__WEBPACK_IMPORTED_MODULE_23__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _navbar_combo__WEBPACK_IMPORTED_MODULE_24__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _list__WEBPACK_IMPORTED_MODULE_25__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _swiper__WEBPACK_IMPORTED_MODULE_34__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _rater__WEBPACK_IMPORTED_MODULE_35__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _draggable__WEBPACK_IMPORTED_MODULE_27__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _kanban__WEBPACK_IMPORTED_MODULE_28__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _fullcalendar__WEBPACK_IMPORTED_MODULE_29__.fullCalendarInit
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _calendar_index__WEBPACK_IMPORTED_MODULE_30__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _calendar_management_calendar__WEBPACK_IMPORTED_MODULE_31__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _lottie__WEBPACK_IMPORTED_MODULE_32__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _wizard__WEBPACK_IMPORTED_MODULE_33__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _search__WEBPACK_IMPORTED_MODULE_36__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _cookie_notice__WEBPACK_IMPORTED_MODULE_37__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _theme_control__WEBPACK_IMPORTED_MODULE_38__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _dropdown_on_hover__WEBPACK_IMPORTED_MODULE_39__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_market_share_ecommerce__WEBPACK_IMPORTED_MODULE_45__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_chartjs_product_share_doughnut__WEBPACK_IMPORTED_MODULE_40__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_total_sales_ecommerce__WEBPACK_IMPORTED_MODULE_41__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_bandwidth_saved__WEBPACK_IMPORTED_MODULE_81__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_sales_by_pos_location__WEBPACK_IMPORTED_MODULE_42__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_returning_customer_rate__WEBPACK_IMPORTED_MODULE_43__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_candle_chart__WEBPACK_IMPORTED_MODULE_50__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_gross_revenue__WEBPACK_IMPORTED_MODULE_51__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _scrollbar__WEBPACK_IMPORTED_MODULE_52__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _icons__WEBPACK_IMPORTED_MODULE_53__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_report_for_this_week__WEBPACK_IMPORTED_MODULE_54__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_echarts__WEBPACK_IMPORTED_MODULE_84__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_basic_echarts__WEBPACK_IMPORTED_MODULE_55__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_chartjs_chart_scatter__WEBPACK_IMPORTED_MODULE_56__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_chartjs_chart_doughnut__WEBPACK_IMPORTED_MODULE_57__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_chartjs_chart_pie__WEBPACK_IMPORTED_MODULE_58__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_chartjs_chart_polar__WEBPACK_IMPORTED_MODULE_59__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_chartjs_chart_radar__WEBPACK_IMPORTED_MODULE_60__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_chartjs_chart_combo__WEBPACK_IMPORTED_MODULE_61__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _dropdown_menu__WEBPACK_IMPORTED_MODULE_63__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_audience__WEBPACK_IMPORTED_MODULE_64__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_session_by_browser__WEBPACK_IMPORTED_MODULE_65__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_session_by_country__WEBPACK_IMPORTED_MODULE_66__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_active_users_report__WEBPACK_IMPORTED_MODULE_67__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_traffic_channels__WEBPACK_IMPORTED_MODULE_68__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_bounce_rate__WEBPACK_IMPORTED_MODULE_69__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_users_by_time__WEBPACK_IMPORTED_MODULE_70__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_session_by_country_map__WEBPACK_IMPORTED_MODULE_71__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_most_leads__WEBPACK_IMPORTED_MODULE_72__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_closed_vs_goal__WEBPACK_IMPORTED_MODULE_73__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_lead_conversion__WEBPACK_IMPORTED_MODULE_74__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_deal_storage_funnel__WEBPACK_IMPORTED_MODULE_75__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_crm_revenue__WEBPACK_IMPORTED_MODULE_76__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_location_by_session_crm__WEBPACK_IMPORTED_MODULE_77__[
        "default"
      ]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_real_time_users__WEBPACK_IMPORTED_MODULE_78__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_echarts_line_payment__WEBPACK_IMPORTED_MODULE_79__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_chartjs_chart_bubble__WEBPACK_IMPORTED_MODULE_62__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _charts_chartjs_chart_line__WEBPACK_IMPORTED_MODULE_80__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _treeview__WEBPACK_IMPORTED_MODULE_82__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _scroll__WEBPACK_IMPORTED_MODULE_83__["default"]
    );
    (0, _utils__WEBPACK_IMPORTED_MODULE_0__.docReady)(
      _anchor__WEBPACK_IMPORTED_MODULE_85__["default"]
    );
  })();
  ...
  $("#select_accessible .form-select").removeClass("select2-hidden-accessible");
  $("#select_accessible .select2").addClass("d-none");
  ...
  var mx;
  $(".table-responsive .dt-scroll-body").on({
  ...
  const realFileBtn = document.querySelector(".upload-form");
  const customBtn = document.getElementById("upload-button");
  const customTxt = document.getElementById("file-title");
  ...
  window.addEventListener("DOMContentLoaded", () => {
    const showBtn1 = document.querySelector("#pass.bx-show-alt");
    const showBtn2 = document.querySelector("#conf_pass.bx-show-alt");
    const passwordEl1 = document.querySelector(".form_password");
    const passwordEl2 = document.querySelector(".form_confirmation");

    showBtn1 &&
      showBtn1.addEventListener("click", () => {
        if (passwordEl1.type === "password") {
          passwordEl1.type = "text";
          showBtn1.classList.replace("bx-show-alt", "bxs-show");
          console.log(showBtn1);
        } else {
          passwordEl1.type = "password";
          showBtn1.classList.replace("bxs-show", "bx-show-alt");
        }
      });
    ...
    showBtn2 &&
      showBtn2.addEventListener("click", () => {
        if (passwordEl2.type === "password") {
          ...
          showBtn2.classList.replace("bx-show-alt", "bxs-show");
          console.log(showBtn2);
        } else {
          passwordEl2.type = "password";
          showBtn2.classList.replace("bxs-show", "bx-show-alt");
        }
      });
  });
