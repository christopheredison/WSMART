                ...
                <a class="notification notification-flush ${readClass} notification-item py-2" 
                   ...
                   data-link='${safeLinkAttr}'>
                    ...
                    <div class="notification-body">
                        ...
                        <p class="mb-1 text-muted small" style="font-weight: 400;">${message.length > 60 ? message.substring(0, 60) + '...' : message}</p>
                        <span class="notification-time small" style="color: #666; font-size: 11px;">
                            ${notification.created_at ? new Date(notification.created_at).toISOString().replace('T', ' ').substring(0, 19) : '2023-06-15 14:28:48'}
                        </span>
                    </div>
                </a>
            </div>
