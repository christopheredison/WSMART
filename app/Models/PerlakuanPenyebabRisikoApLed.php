...
class PerlakuanPenyebabRisikoApLed extends Model
{
    use HasFactory;
    ...
    public function penyebabRisikoApLed()
    {
        return $this->belongsTo(PenyebabRisikoApLed::class, 'penyebab_risiko_led_id');
    }
