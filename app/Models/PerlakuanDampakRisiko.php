...
class PerlakuanDampakRisiko extends Model
{
    ...
    {
        return $this->belongsTo(DampakRisikoProject::class, 'dampak_risiko_id')->withTrashed();
    }
    ...
    public function documents() {
        return $this->hasMany(PerlakuanDampakRisikoDocument::class, 'perlakuan_dampak_risiko_id');
    }
}
